(function() {
    ...
    function $d(t, i, e) {
        return i && pc(t.prototype, i), e && pc(t, e), t
    }
    var i = {},
        le = function(A) {
    ...
    i = {
        addFontGaegu: le,
        addFontIndieFlower: qe
    };
    var Nb = function($, t) {
        return $ < t ? -1 : $ > t ? 1 : $ >= t ? 0 : NaN
    };
    var te = function(r) {
        return 1 === r.length && (r = Pf(r)), {
            left: function(n, t, e, $) {
    ...
    var u = function(e, o) {
        let t, l;
        if (void 0 === o)
            for (const $ of e) null != $ && (void 0 === t ? $ >= $ && (t = l = $) : (t > $ && (t = $), l < $ && (l = $)));
        else {
            let $ = -1;
            for (let f of e) null != (f = o(f, ++$, e)) && (void 0 === t ? f >= f && (t = l = f) : (t > f && (t = f), l < f && (l = f)))
        }
        return [t, l]
    };
    ...
    var Ib = Math.sqrt(50),
        ...
        Tf = function($, t, r) {
            ...
            if ((e = t < $) && (a = $, $ = t, t = a), 0 === (z = va($, t, r)) || !isFinite(z)) return [];
            if (z > 0)
                for ($ = Math.ceil($ / z), t = Math.floor(t / z), o = new Array(a = Math.ceil(t - $ + 1)); ++E < a;) o[E] = ($ + E) * z;
            else
                for ($ = Math.floor($ * z), t = Math.ceil(t * z), o = new Array(a = Math.ceil($ - t + 1)); ++E < a;) o[E] = ($ - E) / z;
            return e && o.reverse(), o
        };

    function va($, t, r) {
        var e = (t - $) / Math.max(0, r),
            a = Math.floor(Math.log(e) / Math.LN10),
            o = e / Math.pow(10, a);
        return a >= 0 ? (o >= Ib ? 10 : o >= Hb ? 5 : o >= Gb ? 2 : 1) * Math.pow(10, a) : -Math.pow(10, -a) / (o >= Ib ? 10 : o >= Hb ? 5 : o >= Gb ? 2 : 1)
    }

    function Yf($, t, r) {
        var e = Math.abs(t - $) / Math.max(0, r),
            a = Math.pow(10, Math.floor(Math.log(e) / Math.LN10)),
            o = e / a;
        return o >= Ib ? a *= 10 : o >= Hb ? a *= 5 : o >= Gb && (a *= 2), t < $ ? -a : a
    }
    ...
    function x(e, o) {
        ...
        if (void 0 === o)
            ...
            let l = -1;
            for (let u of e) null != (u = o(u, ++l, e)) && (t < u || void 0 === t && u >= u) && (t = u)
        }
        return t
    }
    ...
    function Pb(e, o) {
        ...
        if (void 0 === o)
            ...
            let l = -1;
            for (let $ of e) null != ($ = o($, ++l, e)) && (t > $ || void 0 === t && $ >= $) && (t = $)
        }
        return t
    }
    ...
    function Tc(t, r) {
        ...
        function u(u) {
            var f = null == n ? r.ticks ? r.ticks.apply(r, $) : r.domain() : n,
                p = null == e ? r.tickFormat ? r.tickFormat.apply(r, $) : Wg : e,
                v = Math.max(a, 0) + c,
                x = r.range(),
                m = +x[0] + .5,
                h = +x[x.length - 1] + .5,
                g = (r.bandwidth ? Hi : Gi)(r.copy()),
                d = u.selection ? u.selection() : u,
                k = d.selectAll(".domain").data([null]),
                y = d.selectAll(".tick").data(f, r).order(),
                b = y.exit(),
                M = y.enter().append("g").attr("class", "tick"),
                _ = y.select("line"),
                F = y.select("text");
            k = k.merge(k.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), y = y.merge(M), _ = _.merge(M.append("line").attr("stroke", "currentColor").attr(l + "2", o * a)), F = F.merge(M.append("text").attr("fill", "currentColor").attr(l, o * v).attr("dy", t === Bb ? "0em" : t === zb ? "0.71em" : "0.32em")), u !== d && (k = k.transition(u), y = y.transition(u), _ = _.transition(u), F = F.transition(u), b = b.transition(u).attr("opacity", rc).attr("transform", function(t) {
                return isFinite(t = g(t)) ? s(t) : this.getAttribute("transform")
            }), M.attr("opacity", rc).attr("transform", function(t) {
                var r = this.parentNode.__axis;
                return s(r && isFinite(r = r(t)) ? r : g(t))
            })), b.remove(), k.attr("d", t === ga || t == Ab ? i ? "M" + o * i + "," + m + "H0.5V" + h + "H" + o * i : "M0.5," + m + "V" + h : i ? "M" + m + "," + o * i + "V0.5H" + h + "V" + o * i : "M" + m + ",0.5H" + h), y.attr("opacity", 1).attr("transform", function(t) {
                return s(g(t))
            }), _.attr(l + "2", o * a), F.attr(l, o * v).text(p), d.filter(Qi).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === Ab ? "start" : t === ga ? "end" : "middle"), d.each(function() {
                this.__axis = g
            })
        }
        return u.scale = function(t) {
            ...
            return $ = Db.call(arguments), u
        }, u.tickArguments = function(t) {
            return arguments.length ? ($ = null == t ? [] : Db.call(t), u) : $.slice()
        }, u.tickValues = function(t) {
            return arguments.length ? (n = null == t ? null : Db.call(t), u) : n && n.slice()
    ...
    function pd($) {
        return function(t, r, e) {
            return 2 === arguments.length && "function" == typeof r && (e = r, r = void 0), Fc(t, r).then(function(t) {
                return $(t, e)
            })
        }
    }
    ...
    function Ed(r) {
        return new Function("d", "return {" + r.map(function(r, $) {
    ...
    function Jd(r) {
        ...
        return r.forEach(function(r) {
            for (var a in r) a in $ || u.push($[a] = a)
        }), u
    }
    ...
    function e(r, $) {
        var u = r + "",
            a = u.length;
        return a < $ ? new Array($ - a + 1).join(0) + u : u
    }

    function Ti(r) {
        return r < 0 ? "-" + e(-r, 6) : r > 9999 ? "+" + e(r, 6) : e(r, 4)
    }
    ...
    function Ui(r) {
        ...
        return isNaN(r) ? "Invalid Date" : Ti(r.getUTCFullYear(), 4) + "-" + e(r.getUTCMonth() + 1, 2) + "-" + e(r.getUTCDate(), 2) + (n ? "T" + e($, 2) + ":" + e(u, 2) + ":" + e(a, 2) + "." + e(n, 3) + "Z" : a ? "T" + e($, 2) + ":" + e(u, 2) + ":" + e(a, 2) + "Z" : u || $ ? "T" + e($, 2) + ":" + e(u, 2) + "Z" : "")
    }
    var Sb = function(r) {
        var $ = new RegExp("[\"" + r + "\n\r]"),
            u = r.charCodeAt(0);
        ...
        function a(r, $) {
            ...
            function W() {
                ...
                if (R) return R = !1, sd;
                var $, a, n = e;
                if (r.charCodeAt(n) === wb) {
                    for (; e++ < t && r.charCodeAt(e) !== wb || r.charCodeAt(++e) === wb;);
                    return ($ = e) >= t ? v = !0 : (a = r.charCodeAt(e++)) === ca ? R = !0 : a === vb && (R = !0, r.charCodeAt(e) === ca && ++e), r.slice(n + 1, $ - 1).replace(/""/g, "\"")
                }
                for (; e < t;) {
                    if ((a = r.charCodeAt($ = e++)) === ca) R = !0;
                    else if (a === vb) R = !0, r.charCodeAt(e) === ca && ++e;
                    else if (a !== u) continue;
                    return r.slice(n, $)
                }
                return v = !0, r.slice(n, t)
            }
            for (r.charCodeAt(t - 1) === ca && --t, r.charCodeAt(t - 1) === vb && --t;
                (a = W()) !== xb;) {
                for (var i = []; a !== sd && a !== xb;) i.push(a), a = W();
                $ && null == (i = $(i, o++)) || n.push(i)
            }
            return n
        }
        ...
        function e(r) {
            return null == r ? "" : r instanceof Date ? Ui(r) : $.test(r += "") ? "\"" + r.replace(/"/g, "\"\"") + "\"" : r
        }
        return {
            parse: function(r, $) {
                var u, n, t = a(r, function(r, a) {
                    if (u) return u(r, a - 1);
                    n = r, u = $ ? Si(r, $) : Ed(r)
                });
                return t.columns = n || [], t
            },
            parseRows: a,
            format: function($, u) {
                return null == u && (u = Jd($)), [u.map(e).join(r)].concat(n($, u)).join("\n")
            },
            formatBody: function(r, $) {
                return null == $ && ($ = Jd(r)), n(r, $).join("\n")
            },
    ...
    var aj = ka.parseRows;
    var _i = ka.format;
    var mj = ka.formatBody;
    var rj = ka.formatRows;
    ...
    var Qc = function(t, r) {
        return fetch(t, r).then(Ii)
    };

    function lb(e) {
        return function($, r) {
            return Fc($, r).then(function($) {
                return new DOMParser().parseFromString($, e)
            })
        }
    }
    var uj = lb("application/xml");
    var vj = lb("text/html");
    var wj = lb("image/svg+xml");
    var jb, s, Di;

    function Ci($) {
        return jb = ui($), s = jb.format, Di = jb.formatPrefix, jb
    }
    var Da = function(e, t) {
    ...
    function na(i) {
        if (!(t = zi.exec(i))) throw new Error("invalid format: " + i);
        var t;
        return new fb({
            fill: t[1],
            align: t[2],
    ...
    na.prototype = fb.prototype, fb.prototype.toString = function() {
    ...
    var vi = function(e, p) {
        ...
        var t = $[0],
            f = $[1],
            o = f - (r = xi = 3 * Math.max(-8, Math.min(8, Math.floor(f / 3))), r) + 1,
            x = t.length;
        return o === x ? t : o > x ? t + new Array(o - x + 1).join("0") : o > 0 ? t.slice(0, o) + "." + t.slice(o) : "0." + new Array(1 - o).join("0") + Da(e, Math.max(0, p + o - 1))[0]
    };
    var Tb = function(r, e) {
        var t = Da(r, e);
        if (!t) return r + "";
    ...
    var Wb = Array.prototype.map,
        Xb = ["y", "z", "a", "f", "p", "n", "\xB5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"],
        ui = function(r) {
            var e = void 0 === r.grouping || void 0 === r.thousands ? Vb : Bi(Wb.call(r.grouping, Number), r.thousands + ""),
                t = void 0 === r.currency ? "" : r.currency[0] + "",
                a = void 0 === r.currency ? "" : r.currency[1] + "",
                i = void 0 === r.decimal ? "." : r.decimal + "",
                m = void 0 === r.numerals ? Vb : Ai(Wb.call(r.numerals, String)),
                $ = void 0 === r.percent ? "%" : r.percent + "",
                o = void 0 === r.minus ? "-" : r.minus + "",
                n = void 0 === r.nan ? "NaN" : r.nan + "";
            ...
            function p(r) {
                var p = (r = na(r)).fill,
                    ...
                    V = r.trim,
                    v = r.type;
                "n" === v ? (M = !0, v = "g") : Ub[v] || (void 0 === I && (I = 12), V = !0, v = "g"), (u || "0" === p && "=" === s) && (u = !0, p = "0", s = "=");
                var d = "$" === f ? t : "#" === f && /[boxX]/.test(v) ? "0" + v.toLowerCase() : "",
                    h = "$" === f ? a : /[%p]/.test(v) ? $ : "",
                    g = Ub[v],
                    x = /[defgprs%]/.test(v);
                ...
                function y(r) {
                    ...
                    if ("c" === v) y = g(r) + y, r = "";
                        ...
                        var j = (r = +r) < 0;
                        if (r = isNaN(r) ? n : g(Math.abs(r), I), V && (r = yi(r)), j && 0 == +r && (j = !1), f = (j ? "(" === c ? c : o : "-" === c || "(" === c ? "" : c) + f, y = ("s" === v ? Xb[8 + xi / 3] : "") + y + (j && "(" === c ? ")" : ""), x)
                            for (t = -1, a = r.length; ++t < a;)
                                if (48 > ($ = r.charCodeAt(t)) || $ > 57) {
                                    y = (46 === $ ? i + r.slice(t + 1) : r.slice(t)) + y, r = r.slice(0, t);
                                    break
                                }
                    }
                    M && !u && (r = e(r, 1 / 0));
                    var b = f.length + r.length + y.length,
                        q = b < l ? new Array(l - b + 1).join(p) : "";
                    switch (M && u && (r = e(q + r, q.length ? l - y.length : 1 / 0), q = ""), s) {
                        case "<":
                            r = f + r + y + q;
                            break;
                        case "=":
                            ...
                            break;
                        case "^":
                            r = q.slice(0, b = q.length >> 1) + f + r + y + q.slice(b);
                            break;
                        default:
                            r = q + f + r + y;
                    }
                ...
                return I = void 0 === I ? 6 : /[gprs]/.test(v) ? Math.max(1, Math.min(21, I)) : Math.max(0, Math.min(20, I)), y.toString = function() {
                    return r + ""
                }, y
            }
            return {
                format: p,
                formatPrefix: function(r, e) {
                    var t = p(((r = na(r)).type = "f", r)),
                        a = 3 * Math.max(-8, Math.min(8, Math.floor(K(e) / 3))),
                        i = Math.pow(10, -a),
                        m = Xb[8 + a / 3];
                    return function(r) {
                        return t(i * r) + m
    ...
    function T() {
        ...
        return delete t.unknown, t.domain = function(n) {
            ...
            return T(e(), [u, a]).round(o).paddingInner($).paddingOuter(l).align(g)
        }, $a.apply(d(), arguments)
    }
    ...
    function hc() {
        return dc(T.apply(null, arguments).paddingInner(1))
    }
    ...
    function za() {
        ...
        return i.domain = function(e) {
            ...
            return za(n, e).unknown(r)
        }, $a.apply(i, arguments), i
    }

    function qi(r) {
        var t = r.domain;
        return r.ticks = function(r) {
            var $ = t();
            return Tf($[0], $[$.length - 1], null == r ? 10 : r)
        }, r.tickFormat = function(r, $) {
            var e = t();
            return Ee(e[0], e[e.length - 1], null == r ? 10 : r, $)
        }, r.nice = function($) {
            null == $ && ($ = 10);
            var e, i = t(),
                n = 0,
                ...
                a = i[n],
                c = i[o];
            return c < a && (e = a, a = c, c = e, e = n, n = o, o = e), (e = va(a, c, $)) > 0 ? (a = Math.floor(a / e) * e, c = Math.ceil(c / e) * e, e = va(a, c, $)) : e < 0 && (a = Math.ceil(a * e) / e, c = Math.floor(c * e) / e, e = va(a, c, $)), e > 0 ? (i[n] = Math.floor(a / e) * e, i[o] = Math.ceil(c / e) * e, t(i)) : e < 0 && (i[n] = Math.ceil(a * e) / e, i[o] = Math.floor(c * e) / e, t(i)), r
        }, r
    }
    ...
    var N = "\\s*([+-]?\\d+)\\s*",
        ...
        oi = /^#([0-9a-f]{3})$/,
        ni = /^#([0-9a-f]{6})$/,
        mi = new RegExp("^rgb\\(" + [N, N, N] + "\\)$"),
        li = new RegExp("^rgb\\(" + [n, n, n] + "\\)$"),
        di = new RegExp("^rgba\\(" + [N, N, N, ja] + "\\)$"),
        Zh = new RegExp("^rgba\\(" + [n, n, n, ja] + "\\)$"),
        Uh = new RegExp("^hsl\\(" + [ja, n, n] + "\\)$"),
        Th = new RegExp("^hsla\\(" + [ja, n, n, ja] + "\\)$"),
        ld = {
            aliceblue: 15792383,
    ...
    function da(r) {
        var e;
        return r = (r + "").trim().toLowerCase(), (e = oi.exec(r)) ? new h((e = parseInt(e[1], 16)) >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | 240 & e, (15 & e) << 4 | 15 & e, 1) : (e = ni.exec(r)) ? qd(parseInt(e[1], 16)) : (e = mi.exec(r)) ? new h(e[1], e[2], e[3], 1) : (e = li.exec(r)) ? new h(255 * e[1] / 100, 255 * e[2] / 100, 255 * e[3] / 100, 1) : (e = di.exec(r)) ? rd(e[1], e[2], e[3], e[4]) : (e = Zh.exec(r)) ? rd(255 * e[1] / 100, 255 * e[2] / 100, 255 * e[3] / 100, e[4]) : (e = Uh.exec(r)) ? Ad(e[1], e[2] / 100, e[3] / 100, 1) : (e = Th.exec(r)) ? Ad(e[1], e[2] / 100, e[3] / 100, e[4]) : ld.hasOwnProperty(r) ? qd(ld[r]) : "transparent" === r ? new h(NaN, NaN, NaN, 0) : null
    }

    function qd(r) {
        return new h(r >> 16 & 255, r >> 8 & 255, 255 & r, 1)
    }

    function rd(r, e, $, t) {
        return t <= 0 && (r = e = $ = NaN), new h(r, e, $, t)
    }

    function Sa(r) {
        return r instanceof v || (r = da(r)), r ? new h((r = r.rgb()).r, r.g, r.b, r.opacity) : new h
    }

    function ya(r, e, $, t) {
        return 1 === arguments.length ? Sa(r) : new h(r, e, $, null == t ? 1 : t)
    }

    function h(r, e, $, t) {
        this.r = +r, this.g = +e, this.b = +$, this.opacity = +t
    }

    function vd() {
        return "#" + Pa(this.r) + Pa(this.g) + Pa(this.b)
    }
    ...
    function Ad(r, e, $, t) {
        return t <= 0 ? r = e = $ = NaN : $ <= 0 || $ >= 1 ? r = e = NaN : e <= 0 && (r = NaN), new m(r, e, $, t)
    }

    function Bd(r) {
        if (r instanceof m) return new m(r.h, r.s, r.l, r.opacity);
        if (r instanceof v || (r = da(r)), !r) return new m;
        ...
        var e = (r = r.rgb()).r / 255,
            ...
            i = o - a,
            l = (o + a) / 2;
        return i ? (n = e === o ? ($ - t) / i + 6 * ($ < t) : $ === o ? (t - e) / i + 2 : (e - $) / i + 4, i /= l < .5 ? o + a : 2 - o - a, n *= 60) : i = l > 0 && l < 1 ? 0 : n, new m(n, i, l, r.opacity)
    }

    function Na(r, e, $, t) {
        return 1 === arguments.length ? Bd(r) : new m(r, e, $, null == t ? 1 : t)
    }

    function m(r, e, $, t) {
        this.h = +r, this.s = +e, this.l = +$, this.opacity = +t
    }

    function hb(r, e, $) {
        return 255 * (r < 60 ? e + ($ - e) * r / 60 : r < 180 ? $ : r < 240 ? e + ($ - e) * (240 - r) / 60 : e)
    }
    L(v, da, {
        copy: function(r) {
        ...
        brighter: function(r) {
            return r = null == r ? M : Math.pow(M, r), new h(this.r * r, this.g * r, this.b * r, this.opacity)
        },
        darker: function(r) {
            return r = null == r ? A : Math.pow(A, r), new h(this.r * r, this.g * r, this.b * r, this.opacity)
        },
        rgb: function() {
            return this
        },
        ...
        brighter: function(r) {
            return r = null == r ? M : Math.pow(M, r), new m(this.h, this.s, this.l * r, this.opacity)
        },
        darker: function(r) {
            return r = null == r ? A : Math.pow(A, r), new m(this.h, this.s, this.l * r, this.opacity)
        },
        rgb: function() {
            var r = this.h % 360 + 360 * (this.h < 0),
                ...
                t = $ + ($ < .5 ? $ : 1 - $) * e,
                a = 2 * $ - t;
            return new h(hb(r >= 240 ? r - 240 : r + 120, a, t), hb(r, a, t), hb(r < 120 ? r + 240 : r - 120, a, t), this.opacity)
        },
        displayable: function() {
    ...
    function Qb($) {
        if ($ instanceof l) return new l($.l, $.a, $.b, $.opacity);
        if ($ instanceof o) return $b($);
        $ instanceof h || ($ = Sa($));
        var r, t, a = Ma($.r),
            f = Ma($.g),
            e = Ma($.b),
            n = Ja((.2225045 * a + .7168786 * f + .0606169 * e) / Kb);
        return a === f && f === e ? r = t = n : (r = Ja((.4360747 * a + .3850649 * f + .1430804 * e) / Kd), t = Ja((.0139322 * a + .0971045 * f + .7141733 * e) / Lb)), new l(116 * n - 16, 500 * (r - n), 200 * (n - t), $.opacity)
    }

    function Oh($, r, t, a) {
        return 1 === arguments.length ? Qb($) : new l($, r, t, null == a ? 1 : a)
    }

    function l($, r, t, a) {
        this.l = +$, this.a = +r, this.b = +t, this.opacity = +a
    }

    function Ja($) {
        return $ > Rh ? Math.pow($, 1 / 3) : $ / Ob + Mb
    }
    ...
    function Lh($) {
        if ($ instanceof o) return new o($.h, $.c, $.l, $.opacity);
        if ($ instanceof l || ($ = Qb($)), 0 === $.a && 0 === $.b) return new o(NaN, 0 < $.l && $.l < 100 ? 0 : NaN, $.l, $.opacity);
        var r = Math.atan2($.b, $.a) * Id;
        return new o(r < 0 ? r + 360 : r, Math.sqrt($.a * $.a + $.b * $.b), $.l, $.opacity)
    }

    function Oa($, r, t, a) {
        return 1 === arguments.length ? Lh($) : new o($, r, t, null == a ? 1 : a)
    }

    function o($, r, t, a) {
        this.h = +$, this.c = +r, this.l = +t, this.opacity = +a
    }

    function $b($) {
        if (isNaN($.h)) return new l($.l, 0, 0, $.opacity);
        var r = $.h * Gd;
        return new l($.l, Math.cos(r) * $.c, Math.sin(r) * $.c, $.opacity)
    }
    L(l, Oh, R(v, {
        brighter: function($) {
            return new l(this.l + Ea * (null == $ ? 1 : $), this.a, this.b, this.opacity)
        },
        darker: function($) {
            return new l(this.l - Ea * (null == $ ? 1 : $), this.a, this.b, this.opacity)
        },
        rgb: function() {
            var $ = (this.l + 16) / 116,
                r = isNaN(this.a) ? $ : $ + this.a / 500,
                t = isNaN(this.b) ? $ : $ - this.b / 200;
            return r = Kd * Ka(r), $ = Kb * Ka($), t = Lb * Ka(t), new h(La(3.1338561 * r - 1.6168667 * $ - .4906146 * t), La(-.9787684 * r + 1.9161415 * $ + .033454 * t), La(.0719453 * r - .2289914 * $ + 1.4052427 * t), this.opacity)
        }
    })), L(o, Oa, R(v, {
        brighter: function($) {
            return new o(this.h, this.c, this.l + Ea * (null == $ ? 1 : $), this.opacity)
        },
        darker: function($) {
            return new o(this.h, this.c, this.l - Ea * (null == $ ? 1 : $), this.opacity)
        },
    ...
    function Jh($) {
        if ($ instanceof E) return new E($.h, $.s, $.l, $.opacity);
        $ instanceof h || ($ = Sa($));
        var r = $.r / 255,
            t = $.g / 255,
            e = $.b / 255,
            C = (gc * e + ec * r - fc * t) / (gc + ec - fc),
            a = e - C,
            M = (ba * (t - C) - Ra * a) / xa,
            i = Math.sqrt(M * M + a * a) / (ba * C * (1 - C)),
            X = i ? Math.atan2(M, a) * Id - 120 : NaN;
        return new E(X < 0 ? X + 360 : X, i, C, $.opacity)
    }

    function Va($, r, t, e) {
        return 1 === arguments.length ? Jh($) : new E($, r, t, null == e ? 1 : e)
    }
    ...
    L(E, Va, R(v, {
        brighter: function($) {
            return $ = null == $ ? M : Math.pow(M, $), new E(this.h, this.s, this.l * $, this.opacity)
        },
        darker: function($) {
            return $ = null == $ ? A : Math.pow(A, $), new E(this.h, this.s, this.l * $, this.opacity)
        },
        rgb: function() {
            var $ = isNaN(this.h) ? 0 : (this.h + 120) * Gd,
                r = +this.l,
                t = isNaN(this.s) ? 0 : this.s * r * (1 - r),
                e = Math.cos($),
                C = Math.sin($);
            return new h(255 * (r + t * (_b * e + Qa * C)), 255 * (r + t * (Ra * e + xa * C)), 255 * (r + t * (ba * e)), this.opacity)
        }
    }));
    ...
    var Ih = function($) {
        var r = $.length - 1;
        return function(t) {
            var e = t <= 0 ? t = 0 : t >= 1 ? (t = 1, r - 1) : Math.floor(t * r),
                a = $[e],
                l = $[e + 1],
                o = e > 0 ? $[e - 1] : 2 * a - l,
                s = e < r - 1 ? $[e + 2] : 2 * l - a;
            return kc((t - e / r) * r, o, a, l, s)
        }
    };
    var Eh = function(r) {
        var $ = r.length;
        return function(t) {
            var e = Math.floor(((t %= 1) < 0 ? ++t : t) * $),
                n = r[(e + $ - 1) % $],
                a = r[e % $],
                o = r[(e + 1) % $],
                h = r[(e + 2) % $];
            return kc((t - e / $) * $, n, a, o, h)
        }
    };
    ...
    function zh($, t, r) {
        return $ = Math.pow($, r), t = Math.pow(t, r) - $, r = 1 / r,
            function(n) {
    ...
    function Ya($, t) {
        var r = t - $;
        return r ? nc($, r > 180 || r < -180 ? r - 360 * Math.round(r / 360) : r) : wa(isNaN($) ? t : $)
    }

    function wh($) {
        return 1 == ($ = +$) ? k : function(t, r) {
            return r - t ? zh(t, r, $) : wa(isNaN(t) ? r : t)
        }
    }

    function k($, t) {
        var r = t - $;
        return r ? nc($, r) : wa(isNaN($) ? t : $)
    }
    var wa = function(t) {
        return function() {
            return t
    ...
    var tc = function r($) {
        ...
        function e(r, $) {
            var e = o((r = ya(r)).r, ($ = ya($)).r),
                a = o(r.g, $.g),
                t = o(r.b, $.b),
                i = k(r.opacity, $.opacity);
            return function($) {
    ...
    function uc(r) {
        return function($) {
            var o, e, a = $.length,
                ...
                i = new Array(a),
                v = new Array(a);
            for (o = 0; o < a; ++o) e = ya($[o]), t[o] = e.r || 0, i[o] = e.g || 0, v[o] = e.b || 0;
            return t = r(t), i = r(i), v = r(v), e.opacity = 1,
                function(r) {
    ...
    var Vg = function(r, e) {
        var t, $ = e ? e.length : 0,
            a = r ? Math.min($, r.length) : 0,
            n = new Array(a),
            o = new Array($);
        for (t = 0; t < a; ++t) n[t] = eb(r[t], e[t]);
        for (; t < $; ++t) o[t] = e[t];
        return function(r) {
    ...
    var Tg = function(e, r) {
        var t, $ = {},
            i = {};
        for (t in null !== e && "object" == typeof e || (e = {}), null !== r && "object" == typeof r || (r = {}), r) t in e ? $[t] = eb(e[t], r[t]) : i[t] = r[t];
        return function(e) {
            for (t in $) i[t] = $[t](e);
            return i
        }
    ...
    var kg = function(r, $) {
        var n, e, t, a = bb.lastIndex = cb.lastIndex = 0,
            u = -1,
            E = [],
            o = [];
        for (r += "", $ += "";
            (n = bb.exec(r)) && (e = cb.exec($));)(t = e.index) > a && (t = $.slice(a, t), E[u] ? E[u] += t : E[++u] = t), (n = n[0]) === (e = e[0]) ? E[u] ? E[u] += e : E[++u] = e : (E[++u] = null, o.push({
            i: u,
            x: q(n, e)
        })), a = cb.lastIndex;
        return a < $.length && (t = $.slice(a), E[u] ? E[u] += t : E[++u] = t), E.length < 2 ? o[0] ? mg(o[0].x) : Mg($) : ($ = o.length, function(r) {
    ...
    var eb = function(r, $) {
        var e, c = typeof $;
        return null == $ || "boolean" === c ? wa($) : ("number" === c ? q : "string" === c ? (e = da($)) ? ($ = e, tc) : kg : $ instanceof da ? tc : $ instanceof Date ? Ug : Array.isArray($) ? Vg : "function" != typeof $.valueOf && "function" != typeof $.toString || isNaN($) ? Tg : q)(r, $)
    };
    var ig = function(t, n) {
        return n -= t = +t,
            function(r) {
    ...
    function Ic(r, e, t, n) {
        ...
        return function($, s) {
            ...
            return $ = r($), s = r(s),
                function(r, n, a, $, s, o) {
                    if (r !== a || n !== $) {
                        var p = s.push("translate(", null, e, null, t);
                        o.push({
                            i: p - 4,
                            x: q(r, a)
                        }, {
                    ...
                    } else(a || $) && s.push("translate(" + a + e + $ + t)
                }($.translateX, $.translateY, s.translateX, s.translateY, o, p),
                function(r, e, t, $) {
                    r !== e ? (r - e > 180 ? e += 360 : e - r > 180 && (r += 360), $.push({
                        i: t.push(a(t) + "rotate(", null, n) - 2,
                        x: q(r, e)
                    })) : e && t.push(a(t) + "rotate(" + e + n)
                }($.rotate, s.rotate, o, p),
                function(r, e, t, $) {
                    r !== e ? $.push({
                        i: t.push(a(t) + "skewX(", null, n) - 2,
                        x: q(r, e)
                    }) : e && t.push(a(t) + "skewX(" + e + n)
                }($.skewX, s.skewX, o, p),
                function(r, e, t, n, $, s) {
                    if (r !== t || e !== n) {
                        var o = $.push(a($) + "scale(", null, ",", null, ")");
                        s.push({
                            i: o - 4,
                            x: q(r, t)
                        }, {
                    ...
                    } else 1 === t && 1 === n || $.push(a($) + "scale(" + t + "," + n + ")")
                }($.scaleX, $.scaleY, s.scaleX, s.scaleY, o, p), $ = s = null,
                function(r) {
                    for (var e, t = -1, n = p.length; ++t < n;) o[(e = p[t]).i] = e.x(r);
                    return o.join("")
                }
        }
    }
    ...
    function _f($) {
        return "none" === $ ? Jb : (oa || (oa = document.createElement("DIV"), Kc = document.documentElement, bg = document.defaultView), oa.style.transform = $, $ = bg.getComputedStyle(Kc.appendChild(oa), null).getPropertyValue("transform"), Kc.removeChild(oa), $ = $.slice(7, -1).split(","), Rc(+$[0], +$[1], +$[2], +$[3], +$[4], +$[5]))
    }

    function $f($) {
        return null == $ ? Jb : (gb || (gb = document.createElementNS("http://www.w3.org/2000/svg", "g")), gb.setAttribute("transform", $), ($ = gb.transform.baseVal.consolidate()) ? ($ = $.matrix, Rc($.a, $.b, $.c, $.d, $.e, $.f)) : Jb)
    }
    var Pc = 180 / Math.PI,
        Jb = {
            translateX: 0,
    ...
    var Rc = function(t, e, a, $, r, s) {
        var X, n, w;
        return (X = Math.sqrt(t * t + e * e)) && (t /= X, e /= X), (w = t * a + e * $) && (a -= t * w, $ -= e * w), (n = Math.sqrt(a * a + $ * $)) && (a /= n, $ /= n, w /= n), t * $ < e * a && (t = -t, e = -e, w = -w, X = -X), {
            translateX: r,
            translateY: s,
            rotate: Math.atan2(e, t) * Pc,
            skewX: Math.atan(w) * Pc,
            scaleX: X,
            scaleY: n
        }
    };
    var zj = Ic(_f, "px, ", "px)", "deg)");
    var Aj = Ic($f, ", ", ")", ")");
    var Dj = Math.SQRT2;

    function Vc($) {
        return function(r, e) {
            var o = $((r = Na(r)).h, (e = Na(e)).h),
                t = k(r.s, e.s),
                l = k(r.l, e.l),
                d = k(r.opacity, e.opacity);
            return function($) {
    ...
    function Yc($) {
        return function(r, o) {
            var c = $((r = Oa(r)).h, (o = Oa(o)).h),
                t = k(r.c, o.c),
                x = k(r.l, o.l),
                l = k(r.opacity, o.opacity);
            return function($) {
    ...
    function _c($) {
        return function r(o) {
            function V(r, V) {
                var e = $((r = Va(r)).h, (V = Va(V)).h),
                    t = k(r.s, V.s),
                    i = k(r.l, V.l),
                    l = k(r.opacity, V.opacity);
                return function($) {
    ...
    function Ne(r, n, t) {
        var e = r[0],
            ...
            o = n[0],
            i = n[1];
        return $ < e ? (e = kb($, e), o = t(i, o)) : (e = kb(e, $), o = t(o, i)),
            function(r) {
                return o(e(r))
            }
    }
    ...
    function Me(r, n, t) {
        var e = Math.min(r.length, n.length) - 1,
            ...
            o = new Array(e),
            i = -1;
        for (r[e] < r[0] && (r = r.slice().reverse(), n = n.slice().reverse()); ++i < e;) $[i] = kb(r[i], r[i + 1]), o[i] = t(n[i], n[i + 1]);
        return function(n) {
            var t = cc(r, n, 1, e) - 1;
            return o[t]($[t](n))
        }
    ...
    function He() {
        ...
        function j() {
            var r = Math.min(i.length, a.length);
            return p !== O && (p = Xe(i[0], i[r - 1])), e = r > 2 ? Me : Ne, $ = o = null, C
        }

        function C(n) {
            return isNaN(n = +n) ? t : ($ || ($ = e(i.map(r), a, u)))(r(p(n)))
        }
        return C.invert = function(t) {
                return p(n((o || (o = e(a, i.map(r), q)))(t)))
            }, C.domain = function(r) {
                return arguments.length ? (i = Array.from(r, Ze), j()) : i.slice()
            }, C.range = function(r) {
                return arguments.length ? (a = Array.from(r), j()) : a.slice()
            }, C.rangeRound = function(r) {
                return a = Array.from(r), u = ig, j()
            }, C.clamp = function(r) {
                return arguments.length ? (p = !!r || O, j()) : p !== O
            }, C.interpolate = function(r) {
                return arguments.length ? (u = r, j()) : u
    ...
    var Ee = function(a, r, e, i) {
        var $, t = Yf(a, r, e);
        switch ((i = na(null == i ? ",f" : i)).type) {
            case "s":
                var p = Math.max(Math.abs(a), Math.abs(r));
                return null != i.precision || isNaN($ = si(t, p)) || (i.precision = $), Di(i, p);
            case "":
            case "e":
            case "g":
            case "p":
            case "r":
                null != i.precision || isNaN($ = ri(t, Math.max(Math.abs(a), Math.abs(r)))) || (i.precision = $ - ("e" === i.type));
                break;
            case "f":
            case "%":
                null != i.precision || isNaN($ = ti(t)) || (i.precision = $ - 2 * ("%" === i.type));
        }
        return s(i)
    };
    var rb = new Date,
    ...
    function f(t, r, e, n) {
        ...
        return o.floor = o, o.ceil = function(e) {
            ...
            return rb.setTime(+r), sb.setTime(+n), t(rb), t(sb), Math.floor(e(rb, sb))
        }, o.every = function(t) {
    ...
    var ub = f(function() {}, function(e, t) {
        e.setTime(+e + t)
    }, function(e, t) {
        return t - e
    });
    ub.every = function(e) {
        return e = Math.floor(e), isFinite(e) && e > 0 ? e > 1 ? f(function(t) {
    ...
    var Pj = we.range;
    var ie = f(function(e) {
        e.setTime(e - e.getMilliseconds() - e.getSeconds() * Ba)
    }, function(e, t) {
        e.setTime(+e + t * B)
    }, function(e, t) {
        return (t - e) / B
    ...
    var Yj = ie.range;
    var ee = f(function(r) {
        r.setTime(r - r.getMilliseconds() - r.getSeconds() * Ba - r.getMinutes() * B)
    }, function(r, $) {
        r.setTime(+r + $ * ra)
    }, function(r, $) {
        return ($ - r) / ra
    ...
    var Eb = f(function(r) {
        ...
        return (e - r - (e.getTimezoneOffset() - r.getTimezoneOffset()) * B) / wd
    }, function(r) {
        return r.getDate() - 1
    });
    var _j = Eb.range;
    ...
    function F(e) {
        return f(function($) {
            ...
            return ($ - e - ($.getTimezoneOffset() - e.getTimezoneOffset()) * B) / xd
        })
    }
    var Hd = F(0);
    var Fa = F(1);
    ...
    D.every = function(e) {
        return isFinite(e = Math.floor(e)) && e > 0 ? f(function(t) {
    ...
    function Be($) {
        return ha = Fe($), Nj = ha.format, Mj = ha.parse, ze = ha.utcFormat, Ae = ha.utcParse, ha
    }
        ...
        function T(r, $) {
            return function(e) {
                var a, t, U, n = [],
                    ...
                    u = 0,
                    b = r.length;
                for (e instanceof Date || (e = new Date(+e)); ++o < b;) 37 === r.charCodeAt(o) && (n.push(r.slice(u, o)), null != (t = nd[a = r.charAt(++o)]) ? a = r.charAt(++o) : t = "e" === a ? " " : "0", (U = $[a]) && (a = U(e, t)), n.push(a), u = o + 1);
        ...
        function M(r, $) {
            return function(e) {
                ...
                if ("p" in U && (U.H = U.H % 12 + 12 * U.p), "V" in U) {
                    ...
                    "w" in U || (U.w = 1), "Z" in U ? (t = (a = Ga(aa(U.y))).getUTCDay(), a = t > 4 || 0 === t ? sa.ceil(a) : sa(a), a = Fb.offset(a, 7 * (U.V - 1)), U.y = a.getUTCFullYear(), U.m = a.getUTCMonth(), U.d = a.getUTCDate() + (U.w + 6) % 7) : (t = (a = $(aa(U.y))).getDay(), a = t > 4 || 0 === t ? Fa.ceil(a) : Fa(a), a = Eb.offset(a, 7 * (U.V - 1)), U.y = a.getFullYear(), U.m = a.getMonth(), U.d = a.getDate() + (U.w + 6) % 7)
                } else("W" in U || "U" in U) && ("w" in U || (U.w = "u" in U ? U.u % 7 : "W" in U ? 1 : 0), t = "Z" in U ? Ga(aa(U.y)).getUTCDay() : $(aa(U.y)).getDay(), U.m = 0, U.d = "W" in U ? (U.w + 6) % 7 + 7 * U.W - (t + 5) % 7 : U.w + 7 * U.U - (t + 6) % 7);
                return "Z" in U ? (U.H += U.Z / 100 | 0, U.M += U.Z % 100, Ga(U)) : $(U)
            }
        }
        ...
        function h(r, $, e, a) {
            for (var t, U, n = 0, o = $.length, u = e.length; n < o;) {
                ...
                if (37 === (t = $.charCodeAt(n++))) {
                    if (t = $.charAt(n++), !(U = g[t in nd ? $.charAt(n++) : t]) || (a = U(r, e, a)) < 0) return -1
    ...
    function _(r) {
        return new RegExp("^(?:" + r.map(Le).join("|") + ")", "i")
    }
    ...
    function bf(r, $, e) {
        var a = g.exec($.slice(e, e + 6));
        return a ? (r.L = Math.floor(a[0] / 1e3), e + a[0].length) : -1
    }

    function cf(r, $, e) {
        var a = Ie.exec($.slice(e, e + 1));
        return a ? e + a[0].length : -1
    }

    function df(r, $, e) {
        var a = g.exec($.slice(e));
    ...
    function qf(r, $) {
        return a(Hd.count(D(r), r), $, 2)
    }

    function rf(r, $) {
        var e = r.getDay();
        return r = e >= 4 || 0 === e ? ma(r) : ma.ceil(r), a(ma.count(D(r), r) + (4 === D(r).getDay()), $, 2)
    }
    ...
    function Hf(r, $) {
        return a(Cd.count(C(r), r), $, 2)
    }

    function If(r, $) {
        var e = r.getUTCDay();
        return r = e >= 4 || 0 === e ? ta(r) : ta.ceil(r), a(ta.count(C(r), r) + (4 === C(r).getUTCDay()), $, 2)
    }
    ...
    var Uc = "%Y-%m-%dT%H:%M:%S.%LZ";

    function Sf($) {
        return $.toISOString()
    }
    var Cj = Date.prototype.toISOString ? Sf : ze(Uc);

    function Uf(e) {
        var $ = new Date(e);
        return isNaN($) ? null : $
    }
    var Bj = +new Date("2000-01-01T00:00:00.000Z") ? Uf : Ae(Uc);

    function Wf(e) {
        return function() {
            var r = this.ownerDocument,
                t = this.namespaceURI;
            return t === ib && r.documentElement.namespaceURI === ib ? r.createElement(e) : r.createElementNS(t, e)
        }
    }
    ...
    var ib = "http://www.w3.org/1999/xhtml";
    var Sc = {
    ...
    var Oc = function(e) {
        var $ = e += "",
            a = $.indexOf(":");
        return a >= 0 && "xmlns" !== ($ = e.slice(0, a)) && (e = e.slice(a + 1)), Sc.hasOwnProperty($) ? {
            space: Sc[$],
            local: e
        } : e
    };
    var Nc = function(e) {
        var r = Oc(e);
        return (r.local ? Xf : Wf)(r)
    };

    function ag() {}
    var Lc = function($) {
        return null == $ ? ag : function() {
            return this.querySelector($)
        }
    };
    var cg = function(e) {
        "function" != typeof e && (e = Lc(e));
        for (var r = this._groups, t = r.length, a = new Array(t), l = 0; l < t; ++l)
            for (var $, _, o = r[l], n = o.length, i = a[l] = new Array(n), p = 0; p < n; ++p)($ = o[p]) && (_ = e.call($, $.__data__, p, o)) && ("__data__" in $ && (_.__data__ = $.__data__), i[p] = _);
    ...
    var eg = function(t) {
        return null == t ? dg : function() {
            return this.querySelectorAll(t)
        }
    };
    var fg = function(e) {
        "function" != typeof e && (e = eg(e));
        for (var r = this._groups, t = r.length, $ = [], l = [], o = 0; o < t; ++o)
            for (var a, p = r[o], u = p.length, n = 0; n < u; ++n)(a = p[n]) && ($.push(e.call(a, a.__data__, n, p)), l.push(a));
        return new j($, l)
    };
    var gg = function(r) {
        return function() {
    ...
    var hg = function(r) {
        "function" != typeof r && (r = gg(r));
        for (var e = this._groups, a = e.length, t = new Array(a), $ = 0; $ < a; ++$)
            for (var S, o = e[$], n = o.length, p = t[$] = [], i = 0; i < n; ++i)(S = o[i]) && r.call(S, S.__data__, i, o) && p.push(S);
    ...
    var jg = function() {
        return new j(this._enter || this._groups.map(Hc), this._parents)
    };
    ...
    function ng(r, e, n, $, t, a) {
        for (var i, o = 0, l = e.length, f = a.length; o < f; ++o)(i = e[o]) ? (i.__data__ = a[o], $[o] = i) : n[o] = new qa(r, a[o]);
        for (; o < l; ++o)(i = e[o]) && (t[o] = i)
    }

    function og(r, e, n, $, t, a, i) {
        var o, l, f, q = {},
            _ = e.length,
            O = a.length,
            d = new Array(_);
        for (o = 0; o < _; ++o)(l = e[o]) && (d[o] = f = Ec + i.call(l, l.__data__, o, e), f in q ? t[o] = l : q[f] = l);
        for (o = 0; o < O; ++o)(l = q[f = Ec + i.call(r, a[o], o, a)]) ? ($[o] = l, l.__data__ = a[o], q[f] = null) : n[o] = new qa(r, a[o]);
        for (o = 0; o < _; ++o)(l = e[o]) && q[d[o]] === l && (t[o] = l)
    }
    var pg = function(r, e) {
        if (!r) return d = new Array(this.size()), f = -1, this.each(function(r) {
            d[++f] = r
        }), d;
        var n = e ? og : ng,
            $ = this._parents,
            t = this._groups;
        "function" != typeof r && (r = lg(r));
        for (var a = t.length, i = new Array(a), o = new Array(a), l = new Array(a), f = 0; f < a; ++f) {
            var q = $[f],
                _ = t[f],
                O = _.length,
                d = r.call(q, q && q.__data__, f, $),
                u = d.length,
                v = o[f] = new Array(u),
                c = i[f] = new Array(u);
            n(q, _, v, c, l[f] = new Array(O), d, e);
            for (var p, y, h = 0, x = 0; h < u; ++h)
                if (p = v[h]) {
                    for (h >= x && (x = h + 1); !(y = c[x]) && ++x < u;);
                    p._next = y || null
                }
        }
        return (i = new j(i, $))._enter = o, i._exit = l, i
    };
    var qg = function() {
        return new j(this._exit || this._groups.map(Hc), this._parents)
    };
    ...
    var sg = function(r) {
        for (var e = this._groups, t = r._groups, $ = e.length, n = t.length, a = Math.min($, n), o = new Array($), x = 0; x < a; ++x)
            for (var p, i = e[x], l = t[x], u = i.length, f = o[x] = new Array(u), s = 0; s < u; ++s)(p = i[s] || l[s]) && (f[s] = p);
        for (; x < $; ++x) o[x] = e[x];
        return new j(o, this._parents)
    };
    var tg = function() {
        for (var e = this._groups, t = -1, r = e.length; ++t < r;)
            for (var o, $ = e[t], n = $.length - 1, a = $[n]; --n >= 0;)(o = $[n]) && (a && 4 ^ o.compareDocumentPosition(a) && a.parentNode.insertBefore(o, a), a = o);
        return this
    };
    var ug = function(r) {
        function e(e, t) {
        ...
        return new j($, this._parents).order()
    };
    ...
    var yg = function() {
        for (var r = this._groups, t = 0, e = r.length; t < e; ++t)
            for (var $ = r[t], o = 0, u = $.length; o < u; ++o) {
                var a = $[o];
                if (a) return a
            }
        return null
    ...
    var Bg = function(t) {
        for (var r = this._groups, e = 0, $ = r.length; e < $; ++e)
            for (var a, n = r[e], p = 0, o = n.length; p < o; ++p)(a = n[p]) && t.call(a, a.__data__, p, n);
        return this
    };
    ...
    var Ig = function(t, r) {
        ...
        return this.each((null == r ? e.local ? Dg : Cg : "function" == typeof r ? e.local ? Hg : Gg : e.local ? Fg : Eg)(e, r))
    };
    ...
    var Ng = function(e, t, r) {
        return arguments.length > 1 ? this.each((null == t ? Jg : "function" == typeof t ? Lg : Kg)(e, t, null == r ? "" : r)) : Og(this.node(), e)
    };
    ...
    var Sg = function(r, t) {
        return arguments.length > 1 ? this.each((null == t ? Pg : "function" == typeof t ? Rg : Qg)(r, t)) : this.node()[r]
    };
    ...
    function _a(s) {
        return s.classList || new xc(s)
    }

    function xc(s) {
        this._node = s, this._names = Ac(s.getAttribute("class") || "")
    }

    function wc(s, t) {
        for (var a = _a(s), $ = -1, e = t.length; ++$ < e;) a.add(t[$])
    }

    function vc(s, t) {
        for (var a = _a(s), $ = -1, e = t.length; ++$ < e;) a.remove(t[$])
    }
    ...
    function Ld(s, t) {
        return function() {
            (t.apply(this, arguments) ? wc : vc)(this, s)
        }
    }
    xc.prototype = {
        add: function(s) {
    ...
    var _g = function(s, t) {
        var a = Ac(s + "");
        if (arguments.length < 2) {
            for (var $ = _a(this.node()), e = -1, n = a.length; ++e < n;)
                if (!$.contains(a[e])) return !1;
            return !0
        }
        return this.each(("function" == typeof t ? Ld : t ? Yg : Zg)(a, t))
    };
    ...
    var dh = function(t) {
        return arguments.length ? this.each(null == t ? ah : ("function" == typeof t ? ch : bh)(t)) : this.node().textContent
    };
    ...
    var hh = function(n) {
        return arguments.length ? this.each(null == n ? eh : ("function" == typeof n ? gh : fh)(n)) : this.node().innerHTML
    };
    ...
    var mh = function(t) {
        var r = "function" == typeof t ? t : Nc(t);
    ...
    var oh = function(t, r) {
        var e = "function" == typeof t ? t : Nc(t),
            $ = null == r ? nh : "function" == typeof r ? r : Lc(r);
        return this.select(function() {
    ...
    if ("undefined" != typeof document) {
        var xh = document.documentElement;
        "onmouseenter" in xh || (vh = {
    ...
    function Ch(e, t, n) {
        var r = vh.hasOwnProperty(e.type) ? yh : oc;
        return function($, i, p) {
            var o, a = this.__on,
                v = r(t, i, p);
            if (a)
                for (var s = 0, u = a.length; s < u; ++s)
                    if ((o = a[s]).type === e.type && o.name === e.name) return this.removeEventListener(o.type, o.listener, o.capture), this.addEventListener(o.type, o.listener = v, o.capture = n), void(o.value = t);
    ...
    var Dh = function(e, t, n) {
        var r, $, i = Ah(e + ""),
            p = i.length;
        if (!(arguments.length < 2)) {
            for (o = t ? Ch : Bh, null == n && (n = !1), r = 0; r < p; ++r) this.each(o(i[r], t, n));
            return this
        }
        var o = this.node().__on;
        if (o)
            for (var a, v = 0, s = o.length; v < s; ++v)
                for (r = 0, a = o[v]; r < p; ++r)
                    if (($ = i[r]).type === a.type && $.name === a.name) return a.value
    };
    ...
    function Gh(t, n) {
        return function() {
            return mc(this, t, n.apply(this, arguments))
        }
    }
    var Hh = function(t, n) {
        return this.each(("function" == typeof n ? Gh : Fh)(t, n))
    };
    var Xa = [null];
    ...
    function Ia() {
        this._ = "@" + (++Mh).toString(36)
    }
    Ia.prototype = Nh.prototype = {
        constructor: Ia,
        get: function(t) {
            for (var r = this._; !(r in t);)
    ...
    var Ph = function() {
        for (var e, r = qc; e = r.sourceEvent;) r = e;
        return r
    };
    var Qh = function(e, t) {
    ...
    var I = function(e) {
        var $ = Ph();
        return $.changedTouches && ($ = $.changedTouches[0]), Qh(e, $)
    };
    var c = function(e) {
        return "string" == typeof e ? new j([document.querySelectorAll(e)], [document.documentElement]) : new j([null == e ? [] : e], Xa)
    };
    var Ta, p = {};
    ! function(t, e) {
        "object" == typeof p ? p = e() : "function" == typeof Ta && Ta.amd ? Ta(e) : (t = t || self).rough = e()
    }(p, function() {
            ...
            computePathSize(e) {
                ...
                if (t && self.document) try {
                    const i = "http://www.w3.org/2000/svg",
                        h = self.document.createElementNS(i, "svg");
                    h.setAttribute("width", "0"), h.setAttribute("height", "0");
                    const n = self.document.createElementNS(i, "path");
                    n.setAttribute("d", e), h.appendChild(n), self.document.body.appendChild(h);
                    const a = n.getBBox();
                    a && (s[0] = a.width || 0, s[1] = a.height || 0), self.document.body.removeChild(h)
                } catch (t) {}
        ...
        class a {
            ...
            getNextSegment() {
                ...
                return this._theta = s, this._from = [n[0], n[1]], this._segIndex++, {
                    cp1: a,
                    cp2: o,
                    to: n
                }
        ...
        class o {
            ...
            fit(t) {
                const e = [];
                for (const i of this.sets) {
                    const s = i.length;
                    let h = Math.floor(t * s);
                    if (h < 5) {
                        if (s <= 5) continue;
                        h = 5
                    }
                    e.push(this.reduce(i, h))
                }
                let s = "";
                for (const i of e) {
            ...
            reduce(t, e) {
                ...
                for (; s.length > e;) {
                    ...
                    for (let i = 1; i < s.length - 1; i++) {
                        const h = this.distance(s[i - 1], s[i]),
                            n = this.distance(s[i], s[i + 1]),
                            a = this.distance(s[i - 1], s[i + 1]),
                            o = (h + n + a) / 2,
                ...
                if (Math.abs(this.sinAngle) < 1e-4) {
                    ...
                    if (this.pos < this.right + this.deltaX) {
                        for (; t < this.left && e < this.left || t > this.right && e > this.right;)
                            if (this.pos += this.hGap, t = this.pos - this.deltaX / 2, e = this.pos + this.deltaX / 2, this.pos > this.right + this.deltaX) return null;
        ...
        function u(t, e) {
            ...
            for (let h = 0; h < e.length; h++) {
                const t = new r(e[h], e[(h + 1) % e.length]);
                i.intersects(t) && s.push([i.xi, i.yi])
            }
            return s
        }
        ...
        function d(t, e) {
            ...
            if (t && t.length) {
                ...
                const l = o % 180 * (Math.PI / 180),
                    p = Math.cos(l),
                    f = Math.sin(l),
                    d = Math.tan(l),
                    g = new c(n - 1, a + 1, i - 1, h + 1, r, f, p, d);
                let y;
        ...
        function g(t, e, s, i, h, n) {
            ...
            for (let m = e - o + _; m < e + o; m += _) {
                const t = f(m, s - (b = Math.sqrt(o * o - (e - m) * (e - m))), e, s, M, x, g),
                    i = f(m, s + b, e, s, M, x, g);
                a.push([t, i])
            }
            return a
        ...
        class x extends y {
            ...
            fillEllipse(t, e, s, i, h) {
                const n = this._fillEllipse(t, e, s, i, h),
                    a = Object.assign({}, h, {
                        hachureAngle: h.hachureAngle + 90
                    }),
        ...
        class _ {
            ...
            dotsOnLines(t, e) {
                ...
                for (const n of t) {
                    const t = p(n) / i,
                        a = Math.ceil(t) - 1,
                        o = Math.atan((n[1][1] - n[0][1]) / (n[1][0] - n[0][0]));
                    for (let r = 0; r < a; r++) {
                        const t = i * (r + 1),
                            a = t * Math.sin(o),
                            l = t * Math.cos(o),
                            c = [n[0][0] - l, n[0][1] + a],
                            p = this.helper.randOffsetWithRange(c[0] - i / 4, c[0] + i / 4, e),
                            u = this.helper.randOffsetWithRange(c[1] - i / 4, c[1] + i / 4, e),
                            f = this.helper.ellipse(p, u, h, h, e);
                        s = s.concat(f.ops)
                    }
                }
                return {
        ...
        class b {
            ...
            fillPolygon(t, e) {
                const s = [Number.MAX_SAFE_INTEGER, Number.MIN_SAFE_INTEGER],
                ...
                const h = function(t) {
                        ...
                        for (let h = 0; h < t.length; h++) {
                            const s = t[h],
                                i = h === t.length - 1 ? t[0] : t[h + 1];
                            e += s[0] * i[1] - i[0] * s[1]
                        }
                        e /= 2;
                        for (let h = 0; h < t.length; h++) {
                            const e = t[h],
                                n = h === t.length - 1 ? t[0] : t[h + 1];
                            s += (e[0] + n[0]) * (e[0] * n[1] - n[0] * e[1]), i += (e[1] + n[1]) * (e[0] * n[1] - n[0] * e[1])
                        }
                        return [s / (6 * e), i / (6 * e)]
                    }(t),
                    ...
                    o = [];
                if (t.length > 2)
                    for (let l = 0; l < t.length; l++) l === t.length - 1 ? o.push([t[l], t[0]]) : o.push([t[l], t[l + 1]]);
                let r = [];
                const c = Math.max(1, Math.PI * n / a);
                for (let u = 0; u < c; u++) {
                    const t = u * Math.PI / c,
                        e = [h, [h[0] + n * Math.cos(t), h[1] + n * Math.sin(t)]];
                    o.forEach(t => {
                        const h = l(t, e);
                        h && h[0] >= s[0] && h[0] <= s[1] && h[1] >= i[0] && h[1] <= i[1] && r.push(h)
                    })
                }
            ...
            dashedLine(t, e) {
                ...
                return t.forEach(t => {
                    ...
                    for (let p = 0; p < a; p++) {
                        const t = p * (s + i),
                            n = t + s,
                            a = [r[0] + t * Math.cos(c) + o * Math.cos(c), r[1] + t * Math.sin(c) + o * Math.sin(c)],
                            l = [r[0] + n * Math.cos(c) + o * Math.cos(c), r[1] + n * Math.sin(c) + o * Math.sin(c)];
                        h = h.concat(this.helper.doubleLineOps(a[0], a[1], l[0], l[1], e))
                    }
                }), h
            }
        }
        class w {
            ...
            fillPolygon(t, e) {
                const s = e.hachureGap < 0 ? 4 * e.strokeWidth : e.hachureGap,
                    ...
                    h = d(t, e = Object.assign({}, e, {
                        hachureGap: s + i
                    }));
                return {
                    type: "fillSketch",
                    ops: this.zigzagLines(h, i, e)
                }
            }
            fillEllipse(t, e, s, i, h) {
                const n = h.hachureGap < 0 ? 4 * h.strokeWidth : h.hachureGap,
                ...
                return t.forEach(t => {
                    ...
                    for (let l = 0; l < n; l++) {
                        const t = 2 * l * e,
                            ...
                            o = [a[0] + t * Math.cos(r), a[1] + t * Math.sin(r)],
                            c = [a[0] + h * Math.cos(r), a[1] + h * Math.sin(r)],
                            p = [o[0] + n * Math.cos(r + Math.PI / 4), o[1] + n * Math.sin(r + Math.PI / 4)];
                        i = (i = i.concat(this.helper.doubleLineOps(o[0], o[1], p[0], p[1], s))).concat(this.helper.doubleLineOps(p[0], p[1], c[0], c[1], s))
                    }
                }), i
            }
        }
        ...
        const v = {
            ...
            ellipse: O,
            doubleLineOps: function(t, e, s, i, h) {
                return L(t, e, s, i, h)
            }
        };

        function A(t, e, s, i, h) {
            return {
                type: "path",
                ops: L(t, e, s, i, h)
            }
        ...
        function S(t, e, s) {
            ...
            if (i > 2) {
                let h = [];
                for (let e = 0; e < i - 1; e++) h = h.concat(L(t[e][0], t[e][1], t[e + 1][0], t[e + 1][1], s));
                return e && (h = h.concat(L(t[i - 1][0], t[i - 1][1], t[0][0], t[0][1], s))), {
                    type: "path",
                    ops: h
                }
            }
            return 2 === i ? A(t[0][0], t[0][1], t[1][0], t[1][1], s) : {
                type: "path",
                ops: []
            }
        }
        ...
        function O(t, e, s, i, h) {
            const n = 2 * Math.PI / h.curveStepCount;
            let a = Math.abs(s / 2),
                o = Math.abs(i / 2);
            const r = D(n, t, e, a += z(.05 * a, h), o += z(.05 * o, h), 1, n * C(.1, C(.4, 1, h), h), h),
                l = D(n, t, e, a, o, 1.5, 0, h);
            return {
                type: "path",
                ops: r.concat(l)
            }
        ...
        function T(t, e, s, i, h, n, a, o, r) {
            const l = t,
                c = e;
            let p = Math.abs(s / 2),
                u = Math.abs(i / 2);
            p += z(.01 * p, r), u += z(.01 * u, r);
            let f = h,
                d = n;
            ...
            const g = 2 * Math.PI / r.curveStepCount,
                ...
                M = q(y, l, c, p, u, f, d, 1, r),
                x = q(y, l, c, p, u, f, d, 1.5, r);
            let _ = M.concat(x);
            return a && (o ? _ = (_ = _.concat(L(l, c, l + p * Math.cos(f), c + u * Math.sin(f), r))).concat(L(l, c, l + p * Math.cos(d), c + u * Math.sin(d), r)) : (_.push({
                op: "lineTo",
                data: [l, c]
            }), _.push({
                op: "lineTo",
        ...
        function $(t, e) {
            const s = [];
            if (t.length) {
                const i = e.maxRandomnessOffset || 0,
                    h = t.length;
                if (h > 2) {
                    s.push({
                        op: "move",
                        data: [t[0][0] + z(i, e), t[0][1] + z(i, e)]
                    });
                    for (let n = 1; n < h; n++) s.push({
                        op: "lineTo",
                        data: [t[n][0] + z(i, e), t[n][1] + z(i, e)]
                    })
                }
            }
            return {
        ...
        function L(t, e, s, i, h) {
            const n = W(t, e, s, i, h, !0, !1),
                a = W(t, e, s, i, h, !0, !0);
            return n.concat(a)
        }

        function W(t, e, s, i, h, n, a) {
            const o = Math.pow(t - s, 2) + Math.pow(e - i, 2);
            let r = h.maxRandomnessOffset || 0;
            r * r * 100 > o && (r = Math.sqrt(o) / 10);
            const l = r / 2,
                c = .2 + .2 * Math.random();
            let p = h.bowing * h.maxRandomnessOffset * (i - e) / 200,
            ...
            return n && (a ? f.push({
                ...
                op: "move",
                data: [t + z(r, h), e + z(r, h)]
            })), a ? f.push({
                op: "bcurveTo",
                data: [p + t + (s - t) * c + d(), u + e + (i - e) * c + d(), p + t + 2 * (s - t) * c + d(), u + e + 2 * (i - e) * c + d(), s + d(), i + d()]
            }) : f.push({
                op: "bcurveTo",
                data: [p + t + (s - t) * c + g(), u + e + (i - e) * c + g(), p + t + 2 * (s - t) * c + g(), u + e + 2 * (i - e) * c + g(), s + g(), i + g()]
            }), f
        }

        function R(t, e, s) {
            const i = [];
            i.push([t[0][0] + z(e, s), t[0][1] + z(e, s)]), i.push([t[0][0] + z(e, s), t[0][1] + z(e, s)]);
            for (let h = 1; h < t.length; h++) i.push([t[h][0] + z(e, s), t[h][1] + z(e, s)]), h === t.length - 1 && i.push([t[h][0] + z(e, s), t[h][1] + z(e, s)]);
            return I(i, null, s)
        }
        ...
        function I(t, e, s) {
            ...
            })) : 2 === i && (h = h.concat(L(t[0][0], t[0][1], t[1][0], t[1][1], s)));
            return h
        }

        function D(t, e, s, i, h, n, a, o) {
            const r = z(.5, o) - Math.PI / 2,
                l = [];
            l.push([z(n, o) + e + .9 * i * Math.cos(r - t), z(n, o) + s + .9 * h * Math.sin(r - t)]);
            for (let c = r; c < 2 * Math.PI + r - .01; c += t) l.push([z(n, o) + e + i * Math.cos(c), z(n, o) + s + h * Math.sin(c)]);
            return l.push([z(n, o) + e + i * Math.cos(r + 2 * Math.PI + .5 * a), z(n, o) + s + h * Math.sin(r + 2 * Math.PI + .5 * a)]), l.push([z(n, o) + e + .98 * i * Math.cos(r + a), z(n, o) + s + .98 * h * Math.sin(r + a)]), l.push([z(n, o) + e + .9 * i * Math.cos(r + .5 * a), z(n, o) + s + .9 * h * Math.sin(r + .5 * a)]), I(l, null, o)
        }

        function q(t, e, s, i, h, n, a, o, r) {
            const l = n + z(.1, r),
                c = [];
            c.push([z(o, r) + e + .9 * i * Math.cos(l - t), z(o, r) + s + .9 * h * Math.sin(l - t)]);
            for (let p = l; p <= a; p += t) c.push([z(o, r) + e + i * Math.cos(p), z(o, r) + s + h * Math.sin(p)]);
            return c.push([e + i * Math.cos(a), s + h * Math.sin(a)]), c.push([e + i * Math.cos(a), s + h * Math.sin(a)]), I(c, null, r)
        }

        function G(t, e, s, i, h, n, a, o) {
            const r = [],
                l = [o.maxRandomnessOffset || 1, (o.maxRandomnessOffset || 1) + .5];
            let c = [0, 0];
            for (let p = 0; p < 2; p++) 0 === p ? r.push({
                op: "move",
                data: [a.x, a.y]
            }) : r.push({
                op: "move",
                data: [a.x + z(l[0], o), a.y + z(l[0], o)]
            }), c = [h + z(l[p], o), n + z(l[p], o)], r.push({
                op: "bcurveTo",
                data: [t + z(l[p], o), e + z(l[p], o), s + z(l[p], o), i + z(l[p], o), c[0], c[1]]
            });
            ...
            switch (e.key) {
                ...
                case "m": {
                    ...
                    if (e.data.length >= 2) {
                        ...
                        n += z(o, i), a += z(o, i), t.setPosition(n, a), h.push({
                            op: "move",
                            data: [n, a]
                        })
                    }
                ...
                case "l": {
                    ...
                    if (e.data.length >= 2) {
                        let n = +e.data[0],
                            a = +e.data[1];
                        s && (n += t.x, a += t.y), h = h.concat(L(t.x, t.y, n, a, i)), t.setPosition(n, a)
                    }
                    break
                }
                case "H":
                case "h": {
                    ...
                    if (e.data.length) {
                        let n = +e.data[0];
                        s && (n += t.x), h = h.concat(L(t.x, t.y, n, t.y, i)), t.setPosition(n, t.y)
                    }
                    break
                }
                case "V":
                case "v": {
                    ...
                    if (e.data.length) {
                        let n = +e.data[0];
                        s && (n += t.y), h = h.concat(L(t.x, t.y, t.x, n, i)), t.setPosition(t.x, n)
                    }
                    break
                }
                case "Z":
                case "z":
                    t.first && (h = h.concat(L(t.x, t.y, t.first[0], t.first[1], i)), t.setPosition(t.first[0], t.first[1]), t.first = null);
                    break;
                case "C":
                case "c": {
                    const s = "c" === e.key;
                ...
                case "q": {
                    ...
                    if (e.data.length >= 4) {
                        ...
                        const l = 1 * (1 + .2 * i.roughness),
                            c = 1.5 * (1 + .22 * i.roughness);
                        h.push({
                            op: "move",
                            data: [t.x + z(l, i), t.y + z(l, i)]
                        });
                        let p = [o + z(l, i), r + z(l, i)];
                        h.push({
                            op: "qcurveTo",
                            data: [n + z(l, i), a + z(l, i), p[0], p[1]]
                        }), h.push({
                            op: "move",
                            data: [t.x + z(c, i), t.y + z(c, i)]
                        }), p = [o + z(c, i), r + z(c, i)], h.push({
                            op: "qcurveTo",
                            data: [n + z(c, i), a + z(c, i), p[0], p[1]]
                ...
                case "t": {
                    ...
                    if (e.data.length >= 2) {
                        ...
                        const u = 1 * (1 + .2 * i.roughness),
                            f = 1.5 * (1 + .22 * i.roughness);
                        h.push({
                            op: "move",
                            data: [t.x + z(u, i), t.y + z(u, i)]
                        });
                        let d = [a + z(u, i), o + z(u, i)];
                        h.push({
                            op: "qcurveTo",
                            data: [r + z(u, i), l + z(u, i), d[0], d[1]]
                        }), h.push({
                            op: "move",
                            data: [t.x + z(f, i), t.y + z(f, i)]
                        }), d = [a + z(f, i), o + z(f, i)], h.push({
                            op: "qcurveTo",
                            data: [r + z(f, i), l + z(f, i), d[0], d[1]]
                ...
                case "a": {
                    ...
                    if (e.data.length >= 7) {
                        ...
                        if (0 === n || 0 === o) h = h.concat(L(t.x, t.y, p, u, i)), t.setPosition(p, u);
                        else
                            for (let e = 0; e < 1; e++) {
                                const e = new a([t.x, t.y], [p, u], [n, o], r, !!l, !!c);
                                let s = e.getNextSegment();
                                for (; s;) {
                                    const n = G(s.cp1[0], s.cp1[1], s.cp2[0], s.cp2[1], s.to[0], s.to[1], t, i);
        ...
        class X extends e {
            line(t, e, s, i, h) {
                ...
                return this._drawable("line", [A(t, e, s, i, n)], n)
            }
            rectangle(t, e, s, i, h) {
                const n = this._options(h),
                    a = [];
                if (n.fill) {
                    ...
                    "solid" === n.fillStyle ? a.push($(h, n)) : a.push(N(h, n))
                }
                return a.push(function(t, e, s, i, h) {
                    return function(t, e) {
                        return S(t, !0, h)
                    }([
                        [t, e],
                ...
                }(t, e, s, i, n)), this._drawable("rectangle", a, n)
            }
            ellipse(t, e, s, i, h) {
                const n = this._options(h),
                    a = [];
                ...
                return a.push(O(t, e, s, i, n)), this._drawable("ellipse", a, n)
            }
            circle(t, e, s, i) {
            ...
            linearPath(t, e) {
                ...
                return this._drawable("linearPath", [S(t, !1, s)], s)
            }
            arc(t, e, s, i, h, n, a = !1, o) {
                ...
                if (a && r.fill)
                    if ("solid" === r.fillStyle) {
                        ...
                        let c = Math.abs(s / 2),
                            p = Math.abs(i / 2);
                        c += z(.01 * c, a), p += z(.01 * p, a);
                        let u = h,
                            f = n;
                        for (; u < 0;) u += 2 * Math.PI, f += 2 * Math.PI;
                        f - u > 2 * Math.PI && (u = 0, f = 2 * Math.PI);
                        const d = (f - u) / a.curveStepCount,
                            g = [];
                        for (let y = u; y <= f; y += d) g.push([r + c * Math.cos(y), l + p * Math.sin(y)]);
                        return g.push([r + c * Math.cos(f), l + p * Math.sin(f)]), g.push([r, l]), N(g, a)
                    }(t, e, s, i, h, n, r));
                return l.push(T(t, e, s, i, h, n, a, !0, r)), this._drawable("arc", l, r)
            }
            curve(t, e) {
                const s = this._options(e);
                return this._drawable("curve", [E(t, s)], s)
            }
            polygon(t, e) {
                const s = this._options(e),
                    i = [];
                if (s.fill)
                    if ("solid" === s.fillStyle) i.push($(t, s));
                    else {
                        const e = this.computePolygonSize(t),
                            h = N([
                                [0, 0],
                                [e[0], 0],
                                [e[0], e[1]],
                    ...
                    } return i.push(S(t, !0, s)), this._drawable("polygon", i, s)
            }
            path(t, e) {
                const s = this._options(e),
                    i = [];
                ...
                if (s.fill)
                    ...
                    for (let n = 0; n < h.length; n++) {
                        const t = B(s, h[n], n > 0 ? h[n - 1] : null, e);
        ...
        class V {
            ...
            draw(t) {
                const e = t.sets || [],
                    ...
                    i = this.ctx;
                for (const h of e) switch (h.type) {
                    case "path":
                        i.save(), i.strokeStyle = s.stroke, i.lineWidth = s.strokeWidth, this._drawToContext(i, h), i.restore();
                        break;
                    case "fillPath":
                        i.save(), i.fillStyle = s.fill || "", this._drawToContext(i, h), i.restore();
                        break;
                    case "fillSketch":
                        this.fillSketch(i, h, s);
                        break;
                    case "path2Dfill": {
                        this.ctx.save(), this.ctx.fillStyle = s.fill || "";
                        const t = new Path2D(h.path);
                        this.ctx.fill(t), this.ctx.restore();
                        break
                    }
                    case "path2Dpattern": {
                        const t = this.canvas.ownerDocument || U && document;
                        if (t) {
                            const e = h.size,
                                i = t.createElement("canvas"),
                                n = i.getContext("2d"),
                                a = this.computeBBox(h.path);
                            a && (a.width || a.height) ? (i.width = this.canvas.width, i.height = this.canvas.height, n.translate(a.x || 0, a.y || 0)) : (i.width = e[0], i.height = e[1]), this.fillSketch(n, h, s), this.ctx.save(), this.ctx.fillStyle = this.ctx.createPattern(i, "repeat");
                            const o = new Path2D(h.path);
        ...
        class j extends V {
            constructor(t, e) {
                super(t), this.gen = new X(e || null, this.canvas)
            }
            get generator() {
                return this.gen
            }
        ...
        const F = "undefined" != typeof document;
        class Y {
            constructor(t) {
                this.svg = t
            }
            get defs() {
                const t = this.svg.ownerDocument || F && document;
                if (t && !this._defs) {
            ...
            draw(t) {
                ...
                for (const n of e) {
                    ...
                    switch (n.type) {
                        case "path":
                            (t = i.createElementNS("http://www.w3.org/2000/svg", "path")).setAttribute("d", this.opsToPath(n)), t.style.stroke = s.stroke, t.style.strokeWidth = s.strokeWidth + "", t.style.fill = "none";
                            break;
                        case "fillPath":
                            (t = i.createElementNS("http://www.w3.org/2000/svg", "path")).setAttribute("d", this.opsToPath(n)), t.style.stroke = "none", t.style.strokeWidth = "0", t.style.fill = s.fill || null;
                            break;
                        case "fillSketch":
                            t = this.fillSketch(i, n, s);
                            break;
                        case "path2Dfill":
                            (t = i.createElementNS("http://www.w3.org/2000/svg", "path")).setAttribute("d", n.path || ""), t.style.stroke = "none", t.style.strokeWidth = "0", t.style.fill = s.fill || null;
                            break;
                        case "path2Dpattern":
                            if (this.defs) {
                                const e = n.size,
                                    h = i.createElementNS("http://www.w3.org/2000/svg", "pattern"),
                                    a = `rough-${Math.floor(Math.random()*(Number.MAX_SAFE_INTEGER||999999))}`;
                                h.setAttribute("id", a), h.setAttribute("x", "0"), h.setAttribute("y", "0"), h.setAttribute("width", "1"), h.setAttribute("height", "1"), h.setAttribute("height", "1"), h.setAttribute("viewBox", `0 0 ${Math.round(e[0])} ${Math.round(e[1])}`), h.setAttribute("patternUnits", "objectBoundingBox");
                                const o = this.fillSketch(i, n, s);
                                h.appendChild(o), this.defs.appendChild(h), (t = i.createElementNS("http://www.w3.org/2000/svg", "path")).setAttribute("d", n.path || ""), t.style.stroke = "none", t.style.strokeWidth = "0", t.style.fill = `url(#${a})`
                            } else console.error("Cannot render path2Dpattern. No defs/document defined.");
                    }
                    t && h.appendChild(t)
                }
        ...
        class Q extends Y {
            constructor(t, e) {
                super(t), this.gen = new X(e || null, this.svg)
            }
            get generator() {
                return this.gen
            }
    ...
    var Vh = function(t) {
        ...
        Wh = function() {
            function t(i) {
                Ud(this, t), this.el = i.element, this.data = i.data, this.element = i.element, this.margin = i.margin || {
                    top: 50,
                    right: 20,
                    bottom: 70,
                    left: 100
                }, this.title = i.title, this.color = i.color || "skyblue", this.highlight = i.highlight || "coral", this.roughness = Vh(i.roughness) || 1, this.stroke = i.stroke || "black", this.strokeWidth = i.strokeWidth || 1, this.axisStrokeWidth = i.axisStrokeWidth || .5, this.axisRoughness = i.axisRoughness || .5, this.innerStrokeWidth = i.innerStrokeWidth || 1, this.fillStyle = i.fillStyle, this.bowing = i.bowing || 0, this.fillWeight = i.fillWeight || .5, this.simplification = i.simplification || .2, this.interactive = !1 !== i.interactive, this.titleFontSize = i.titleFontSize, this.axisFontSize = i.axisFontSize, this.tooltipFontSize = i.tooltipFontSize || "0.95rem", this.font = i.font || 0, this.dataFormat = "object" === Qd(i.data) ? "object" : "file", this.labels = "object" === this.dataFormat ? "labels" : i.labels, this.values = "object" === this.dataFormat ? "values" : i.values, this.xValueFormat = i.xValueFormat, this.yValueFormat = i.yValueFormat, this.padding = i.padding || .1, this.xLabel = i.xLabel || "", this.yLabel = i.yLabel || "", this.labelFontSize = i.labelFontSize || "1rem", this.initChartValues(i), this.resolveFont(), this.drawChart = this.resolveData(i.data), this.drawChart(), "undefined" !== i.title && this.setTitle(i.title)
            }
            return $d(t, [{
                key: "initChartValues",
                value: function(t) {
                    var i = t.width ? t.width : 350,
                        e = t.height ? t.height : 450;
                    this.width = i - this.margin.left - this.margin.right, this.height = e - this.margin.top - this.margin.bottom, this.roughId = this.el + "_svg", this.graphClass = this.el.substring(1, this.el.length), this.interactionG = "g." + this.graphClass, this.setSvg()
                }
            }, {
                key: "setSvg",
                value: function() {
                    this.svg = b(this.el).append("svg").attr("width", this.width + this.margin.left + this.margin.right).attr("height", this.height + this.margin.top + this.margin.bottom).append("g").attr("id", this.roughId).attr("transform", "translate(" + this.margin.left + "," + this.margin.top + ")")
                }
            }, {
                key: "resolveFont",
                value: function() {
                    0 === this.font || void 0 === this.font || "gaegu" === this.font.toString().toLowerCase() ? (i.addFontGaegu(this.svg), this.fontFamily = "gaeguregular") : 1 === this.font || "indie flower" === this.font.toString().toLowerCase() ? (i.addFontIndieFlower(this.svg), this.fontFamily = "indie_flowerregular") : this.fontFamily = this.font
                }
            }, {
                key: "resolveData",
                value: function(t) {
                    ...
                    return "string" != typeof t ? function() {
                        i.data = t, i.drawFromObject()
                    } : t.includes(".csv") ? function() {
                        G(t).then(function(t) {
                            i.data = t, i.drawFromFile()
                        })
                    } : t.includes(".tsv") ? function() {
                        H(t).then(function(t) {
                            i.data = t, i.drawFromFile()
                        })
                    } : void 0
                ...
                value: function() {
                    var t = this;
                    this.xScale = T().rangeRound([0, this.width]).padding(this.padding).domain("file" === this.dataFormat ? this.data.map(function(i) {
                        return i[t.labels]
                    }) : this.data[t.labels]), this.yScale = w().rangeRound([this.height, 0]).domain("file" === this.dataFormat ? [0, x(this.data, function(i) {
                        return +i[t.values]
                    })] : [0, x(this.data[t.values])])
                }
            }, {
                key: "addLabels",
                value: function() {
                ...
                value: function() {
                    var t = this,
                        i = fa(this.xScale).tickSize(0).tickFormat(function(i) {
                            return t.xValueFormat ? s(t.xValueFormat)(i) : i
                        }),
                        e = ea(this.yScale).tickSize(0).tickFormat(function(i) {
                            return t.yValueFormat ? s(t.yValueFormat)(i) : i
                        });
                    this.svg.append("g").attr("transform", "translate(0," + this.height + ")").call(i).attr("class", "xAxis".concat(this.graphClass)).selectAll("text").attr("transform", "translate(-10,0)rotate(-45)").style("text-anchor", "end").style("font-family", this.fontFamily).style("font-size", void 0 === this.axisFontSize ? "".concat(Math.min(.8, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize).style("opacity", .9), this.svg.append("g").call(e).attr("class", "yAxis".concat(this.graphClass)).selectAll("text").style("font-family", this.fontFamily).style("font-size", void 0 === this.axisFontSize ? "".concat(Math.min(.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize).style("opacity", .9), c("path.domain").attr("stroke", "transparent")
                }
            }, {
                key: "makeAxesRough",
                value: function(t, i) {
                    var e = "xAxis".concat(this.graphClass),
                        a = "yAxis".concat(this.graphClass),
                        s = "rough-".concat(e),
                        h = "rough-".concat(a);
                    b(".".concat(e)).selectAll("path.domain").each(function(e, a) {
                        var h = b(this).node().getAttribute("d"),
                            r = i.path(h, {
                                fillStyle: "hachure"
                            });
                        r.setAttribute("class", s), t.appendChild(r)
                    }), c(".".concat(s)).attr("transform", "translate(0, ".concat(this.height, ")")), b(".".concat(a)).selectAll("path.domain").each(function(e, a) {
                        var s = b(this).node().getAttribute("d"),
                            r = i.path(s, {
                                fillStyle: "hachure"
                            });
                ...
                key: "setTitle",
                value: function(t) {
                    this.svg.append("text").attr("x", this.width / 2).attr("y", 0 - this.margin.top / 2).attr("class", "title").attr("text-anchor", "middle").style("font-size", void 0 === this.titleFontSize ? "".concat(Math.min(40, Math.min(this.width, this.height) / 5), "px") : this.titleFontSize).style("font-family", this.fontFamily).style("opacity", .8).text(t)
                }
            }, {
                key: "addInteraction",
                value: function() {
                    var t = this;
                    c(this.interactionG).data("file" === this.dataFormat ? this.data : this.data.values).append("rect").attr("x", function(i, e) {
                        return "file" === t.dataFormat ? t.xScale(i[t.labels]) : t.xScale(t.data[t.labels][e])
                    }).attr("y", function(i, e) {
                        return "file" === t.dataFormat ? t.yScale(+i[t.values]) : t.yScale(t.data[t.values][e])
                    }).attr("width", this.xScale.bandwidth()).attr("height", function(i, e) {
                        return "file" === t.dataFormat ? t.height - t.yScale(+i[t.values]) : t.height - t.yScale(t.data[t.values][e])
                    }).attr("fill", "transparent");
                    var i = b(this.el).append("div").style("opacity", 0).attr("class", "tooltip").style("position", "absolute").style("background-color", "white").style("border", "solid").style("border-width", "1px").style("border-radius", "5px").style("padding", "3px").style("font-family", this.fontFamily).style("font-size", this.tooltipFontSize).style("pointer-events", "none"),
                        e = this;
                    c(this.interactionG).on("mouseover", function() {
                        i.style("opacity", 1), b(this).select("path").style("stroke", e.highlight), b(this).selectAll("path:nth-child(2)").style("stroke-width", e.strokeWidth + 1.2)
                    }), c(this.interactionG).on("mouseout", function() {
                        i.style("opacity", 0), b(this).select("path").style("stroke", e.color), b(this).selectAll("path:nth-child(2)").style("stroke-width", e.strokeWidth)
                    }), c(this.interactionG).on("mousemove", function(t) {
                        var a = b(this).attr("attrX"),
                            s = b(this).attr("attrY"),
                            h = I(this);
                        i.html("<b>".concat(a, "</b> ")).style("opacity", .95).attr("class", function(t) {}).style("transform", "translate(".concat(h[0] + e.margin.left, "px, \n          ").concat(h[1] - (e.height + e.margin.top + e.margin.bottom), "px)"))
                    })
                }
            }, {
                key: "initRoughObjects",
                value: function() {
                    var $oYNA$$interop$default = y(p);
                    this.roughSvg = document.getElementById(this.roughId), this.rcAxis = $oYNA$$interop$default.d.svg(this.roughSvg, {
                        options: {
                            strokeWidth: this.axisStrokeWidth,
                            roughness: this.axisRoughness
                        }
                    }), this.rc = $oYNA$$interop$default.d.svg(this.roughSvg, {
                        options: {
                            fill: this.color,
                ...
                value: function() {
                    var t = this;
                    this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.values.forEach(function(i, e) {
                        var a = t.rc.rectangle(t.xScale(t.data[t.labels][e]), t.yScale(+i), t.xScale.bandwidth(), t.height - t.yScale(+i), {
                                simplification: t.simplification,
                                fillWeight: t.fillWeight
                            }),
                            s = t.roughSvg.appendChild(a);
                        s.setAttribute("class", t.graphClass), s.setAttribute("attrX", t.data[t.labels][e]), s.setAttribute("attrY", +i)
                    }), c(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth), !0 === this.interactive && this.addInteraction()
                }
            }, {
                key: "drawFromFile",
                value: function() {
                    var t = this;
                    this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.forEach(function(i) {
                        var e = t.rc.rectangle(t.xScale(i[t.labels]), t.yScale(+i[t.values]), t.xScale.bandwidth(), t.height - t.yScale(+i[t.values]), {
                                simplification: t.simplification,
                                fillWeight: t.fillWeight
                            }),
                            a = t.roughSvg.appendChild(e);
                        a.setAttribute("class", t.graphClass), a.setAttribute("attrX", i[t.labels]), a.setAttribute("attrY", +i[t.values])
                    }), c(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth), !0 === this.interactive && this.addInteraction()
                }
            }]), t
        }();
    ...
    function $h(t, i, e) {
        return i && id(t.prototype, i), e && id(t, e), t
    }
    var _h = function(t) {
            return t > 20 ? 20 : t
        },
        ai = function() {
            function t(i) {
                Yh(this, t), this.el = i.element, this.element = i.element, this.margin = i.margin || {
                    top: 50,
                    right: 20,
                    bottom: 50,
                    left: 100
            ...
            return $h(t, [{
                ...
                value: function(t) {
                    ...
                    return "string" != typeof t ? function() {
                        ...
                        G(t).then(function(t) {
                            console.log(t), i.data = t, i.drawFromFile()
                        })
                    } : t.includes(".tsv") ? function() {
                        H(t).then(function(t) {
                            i.data = t, i.drawFromFile()
                ...
                value: function() {
                    var t = this;
                    this.yScale = T().rangeRound([0, this.height]).padding(this.padding).domain("file" === this.dataFormat ? this.data.map(function(i) {
                        return i[t.labels]
                    }) : this.data[t.labels]), this.xScale = w().rangeRound([0, this.width]).domain("file" === this.dataFormat ? [0, x(this.data, function(i) {
                        return +i[t.values]
                    })] : [0, x(this.data[t.values])])
                }
            }, {
                ...
                value: function(t, i) {
                    var e = "xAxis".concat(this.graphClass),
                        ...
                        o = "rough-".concat(a);
                    b(".".concat(e)).selectAll("path.domain").each(function(e, a) {
                        var o = b(this).node().getAttribute("d"),
                            r = i.path(o, {
                                stroke: "black",
                                fillStyle: "hachure"
                            });
                        ...
                        r.setAttribute("class", o), t.appendChild(r)
                    })
                }
            }, {
                key: "setTitle",
                ...
                value: function() {
                    var t = this;
                    c(this.interactionG).data("file" === this.dataFormat ? this.data : this.data.values).append("rect").attr("x", 0).attr("y", function(i, e) {
                        return "file" === t.dataFormat ? t.yScale(i[t.labels]) : t.yScale(t.data[t.labels][e])
                    }).attr("width", function(i, e) {
                        return "file" === t.dataFormat ? t.xScale(+i[t.values]) : t.xScale(t.data[t.values][e])
                    ...
                    c(this.interactionG).on("mouseover", function() {
                        ...
                        var a = b(this).attr("attrX"),
                            s = b(this).attr("attrY"),
                            o = I(this);
                        i.html("<b>".concat(a, "</b> ")).style("opacity", .95).attr("class", function(t) {}).style("transform", "translate(".concat(o[0] + e.margin.left, "px, \n              ").concat(o[1] - (e.height + e.margin.top + e.margin.bottom), "px)"))
                    })
                }
            }, {
                key: "initRoughObjects",
                ...
                value: function() {
                    var t = this;
                    this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.values.forEach(function(i, e) {
                        var a = t.rc.rectangle(0, t.yScale(t.data[t.labels][e]), t.xScale(i), t.yScale.bandwidth(), {
                                simplification: t.simplification,
                                fillWeight: t.fillWeight
                            }),
                            s = t.roughSvg.appendChild(a);
                ...
                value: function() {
                    var t = this;
                    this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.forEach(function(i) {
                        var e = t.rc.rectangle(0, t.yScale(i[t.labels]), t.xScale(+i[t.values]), t.yScale.bandwidth(), {
                                simplification: t.simplification,
                                fillWeight: t.fillWeight
                            }),
                            a = t.roughSvg.appendChild(e);
    ...
    function ei(t, i, e) {
        return i && gd(t.prototype, i), e && gd(t, e), t
    }
    ...
    Za.prototype = ab.prototype = {
        ...
        arcTo: function(t, h, i, s, $) {
            ...
            if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = h);
            else if (e > z) {
                if (Math.abs(M * r - _ * n) > z && $) {
                    var u = i - o,
                        b = s - a,
                        v = r * r + _ * _,
                        l = u * u + b * b,
                        x = Math.sqrt(v),
                        p = Math.sqrt(e),
                        c = $ * Math.tan((Ua - Math.acos((v + e - l) / (2 * x * p))) / 2),
                        f = c / p,
                        y = c / x;
                    Math.abs(f - 1) > z && (this._ += "L" + (t + f * n) + "," + (h + f * M)), this._ += "A" + $ + "," + $ + ",0,0," + +(M * u > n * b) + "," + (this._x1 = t + y * r) + "," + (this._y1 = h + y * _)
                } else this._ += "L" + (this._x1 = t) + "," + (this._y1 = h);
            } else;
        },
        arc: function(t, h, i, s, $, o) {
            t = +t, h = +h, o = !!o;
            var a = (i = +i) * Math.cos(s),
                r = i * Math.sin(s),
                _ = t + a,
                n = h + r,
                M = 1 ^ o,
            ...
            null === this._x1 ? this._ += "M" + _ + "," + n : (Math.abs(this._x1 - _) > z || Math.abs(this._y1 - n) > z) && (this._ += "L" + _ + "," + n), i && (e < 0 && (e = e % Wa + Wa), e > pi ? this._ += "A" + i + "," + i + ",0,1," + M + "," + (t - a) + "," + (h - r) + "A" + i + "," + i + ",0,1," + M + "," + (this._x1 = _) + "," + (this._y1 = n) : e > z && (this._ += "A" + i + "," + i + ",0," + +(e >= Ua) + "," + M + "," + (this._x1 = t + i * Math.cos($)) + "," + (this._y1 = h + i * Math.sin($))))
        },
    ...
    function Ei($) {
        return $ > 1 ? 0 : $ < -1 ? W : Math.acos($)
    }

    function kd($) {
        return $ >= 1 ? Ca : $ <= -1 ? -Ca : Math.asin($)
    }
    var ua = function() {
        var $ = fi,
            t = gi,
        ...
        function e() {
            var e, c, I = +$.apply(this, arguments),
                B = +t.apply(this, arguments),
                L = i.apply(this, arguments) - Ca,
                m = o.apply(this, arguments) - Ca,
                s = Zb(m - L),
                l = m > L;
            if (p || (p = e = ab()), B < I && (c = B, B = I, I = c), B > U) {
                if (s > Y - U) p.moveTo(B * X(L), B * V(L)), p.arc(0, 0, B, L, m, !l), I > U && (p.moveTo(I * X(m), I * V(m)), p.arc(0, 0, I, m, L, l));
                else {
                    var u, y, f = L,
                        x = m,
                        v = L,
                        ...
                        A = T > U && (n ? +n.apply(this, arguments) : Z(I * I + B * B)),
                        R = db(Zb(B - I) / 2, +r.apply(this, arguments)),
                        q = R,
                        P = R;
                    if (A > U) {
                        var b = kd(A / I * V(T)),
                    ...
                    if (R > U) {
                        var w, z = B * X(x),
                            ...
                            D = I * X(v),
                            F = I * V(v);
                        if (s < W && (w = ki(O, S, D, F, z, C, j, k))) {
                            var G = O - w[0],
                                H = S - w[1],
                                J = z - w[0],
                                K = C - w[1],
                                M = 1 / V(Ei((G * J + H * K) / (Z(G * G + H * H) * Z(J * J + K * K))) / 2),
                                N = Z(w[0] * w[0] + w[1] * w[1]);
                            q = db(R, (I - N) / (M - 1)), P = db(R, (B - N) / (M + 1))
                        }
                    }
                    d > U ? P > U ? (u = Ha(D, F, O, S, B, P, l), y = Ha(z, C, j, k, B, P, l), p.moveTo(u.cx + u.x01, u.cy + u.y01), P < R ? p.arc(u.cx, u.cy, P, Q(u.y01, u.x01), Q(y.y01, y.x01), !l) : (p.arc(u.cx, u.cy, P, Q(u.y01, u.x01), Q(u.y11, u.x11), !l), p.arc(0, 0, B, Q(u.cy + u.y11, u.cx + u.x11), Q(y.cy + y.y11, y.cx + y.x11), !l), p.arc(y.cx, y.cy, P, Q(y.y11, y.x11), Q(y.y01, y.x01), !l))) : (p.moveTo(O, S), p.arc(0, 0, B, f, x, !l)) : p.moveTo(O, S), I > U && h > U ? q > U ? (u = Ha(j, k, z, C, I, -q, l), y = Ha(O, S, D, F, I, -q, l), p.lineTo(u.cx + u.x01, u.cy + u.y01), q < R ? p.arc(u.cx, u.cy, q, Q(u.y01, u.x01), Q(y.y01, y.x01), !l) : (p.arc(u.cx, u.cy, q, Q(u.y01, u.x01), Q(u.y11, u.x11), !l), p.arc(0, 0, I, Q(u.cy + u.y11, u.cx + u.x11), Q(y.cy + y.y11, y.cx + y.x11), l), p.arc(y.cx, y.cy, q, Q(y.y11, y.x11), Q(y.y01, y.x01), !l))) : p.arc(0, 0, I, g, v, l) : p.lineTo(j, k)
                }
            } else p.moveTo(0, 0);
        ...
        return e.centroid = function() {
            var r = (+$.apply(this, arguments) + +t.apply(this, arguments)) / 2,
                n = (+i.apply(this, arguments) + +o.apply(this, arguments)) / 2 - W / 2;
            return [X(n) * r, V(n) * r]
        }, e.innerRadius = function(t) {
            return arguments.length ? ($ = "function" == typeof t ? t : d(+t), e) : $
        }, e.outerRadius = function($) {
            return arguments.length ? (t = "function" == typeof $ ? $ : d(+$), e) : t
        }, e.cornerRadius = function($) {
            return arguments.length ? (r = "function" == typeof $ ? $ : d(+$), e) : r
        }, e.padRadius = function($) {
            return arguments.length ? (n = null == $ ? null : "function" == typeof $ ? $ : d(+$), e) : n
        }, e.startAngle = function($) {
            return arguments.length ? (i = "function" == typeof $ ? $ : d(+$), e) : i
        }, e.endAngle = function($) {
            return arguments.length ? (o = "function" == typeof $ ? $ : d(+$), e) : o
        }, e.padAngle = function($) {
            return arguments.length ? (a = "function" == typeof $ ? $ : d(+$), e) : a
        }, e.context = function($) {
    ...
    var Li = function() {
        ...
        function u(u) {
            var i, l, p, h = u.length,
                c = !1;
            for (null == e && (o = $(p = ab())), i = 0; i <= h; ++i) !(i < h && r(l = u[i], i, u)) === c && ((c = !c) ? o.lineStart() : o.lineEnd()), c && o.point(+n(l, i, u), +t(l, i, u));
            if (p) return o = null, p + "" || null
        }
        return u.x = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : d(+t), u) : n
        }, u.y = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : d(+n), u) : t
        }, u.defined = function(n) {
            return arguments.length ? (r = "function" == typeof n ? n : d(!!n), u) : r
        }, u.curve = function(n) {
    ...
    var pa = function() {
        ...
        function a(a) {
            var i, u, l, p, c, A = a.length,
                f = 0,
                s = new Array(A),
                b = new Array(A),
                U = +e.apply(this, arguments),
                Z = Math.min(Y, Math.max(-Y, $.apply(this, arguments) - U)),
                m = Math.min(Math.abs(Z) / A, o.apply(this, arguments)),
                d = m * (Z < 0 ? -1 : 1);
        ...
        return a.value = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : d(+n), a) : t
            ...
            return arguments.length ? ($ = "function" == typeof t ? t : d(+t), a) : $
        }, a.padAngle = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : d(+t), a) : o
        }, a
    };
    var tj = Ri(Mc);
    ...
    Bc.prototype = {
        ...
        point: function(r, e) {
            this._curve.point(e * Math.sin(r), e * -Math.cos(r))
        }
    };
    var oj = Array.prototype.slice;
    var nj = Math.sqrt(1 / 3);
    var zc = Math.sin(W / 10) / Math.sin(7 * W / 10),
        kj = Math.sin(Y / 10) * zc,
        cj = -Math.cos(Y / 10) * zc;
    var bj = Math.sqrt(3);
    var Fj = Math.sqrt(3) / 2,
        $i = 1 / Math.sqrt(12);
        ...
        point: function(t, i) {
            switch (t = +t, i = +i, this._point) {
                ...
                case 2:
                    ...
                    this._line ? this._context.lineTo(e, s) : this._context.moveTo(e, s);
                    break;
                case 3:
                    this._point = 4;
                default:
    ...
    function lc(i, t) {
        this._basis = new mb(i), this._beta = t
    }
    lc.prototype = {
        lineStart: function() {
        ...
        lineEnd: function() {
            var i = this._x,
                ...
                s = i.length - 1;
            if (s > 0)
                for (var n, e = i[0], a = t[0], $ = i[s] - e, r = t[s] - a, h = -1; ++h <= s;) n = h / s, this._basis.point(this._beta * i[h] + (1 - this._beta) * (e + n * $), this._beta * t[h] + (1 - this._beta) * (a + n * r));
    ...
    var ej = function i(t) {
        function s(i) {
            return 1 === t ? new mb(i) : new lc(i, t)
        }
        return s.beta = function(t) {
            return i(+t)
        }, s
    }(.85);
    ...
    function tb(_, t, i) {
        var a = _._x1,
            ...
            l = _._y2;
        if (_._l01_a > U) {
            var o = 2 * _._l01_2a + 3 * _._l01_a * _._l12_a + _._l12_2a,
                n = 3 * _._l01_a * (_._l01_a + _._l12_a);
            a = (a * o - _._x0 * _._l12_2a + _._x2 * _._l01_2a) / n, s = (s * o - _._y0 * _._l12_2a + _._y2 * _._l01_2a) / n
        }
        if (_._l23_a > U) {
            var e = 2 * _._l23_2a + 3 * _._l23_a * _._l12_a + _._l12_2a,
                r = 3 * _._l23_a * (_._l23_a + _._l12_a);
            h = (h * e + _._x1 * _._l23_2a - t * _._l12_2a) / r, l = (l * e + _._y1 * _._l23_2a - i * _._l12_2a) / r
        }
        _._context.bezierCurveTo(a, s, h, l, _._x2, _._y2)
    }
    ...
    var pj = function _(t) {
        function i(_) {
            return t ? new Fd(_, t) : new ob(_, 0)
        }
        return i.alpha = function(t) {
            return _(+t)
        }, i
    }(.5);
    Rb.prototype = {
    ...
    var qj = function t(i) {
        function s(t) {
            return i ? new Rb(t, i) : new nb(t, 0)
        }
        return s.alpha = function(i) {
            return t(+i)
        }, s
    }(.5);
    ...
    var sj = function t(i) {
        function _(t) {
            return i ? new Jc(t, i) : new qb(t, 0)
        }
        return _.alpha = function(i) {
            return t(+i)
        }, _
    }(.5);
    ...
    function Cc(t, o, n) {
        var i = t._x1 - t._x0,
            ...
            s = (n - t._y1) / (e || i < 0 && -0),
            x = ($ * e + s * i) / (i + e);
        return (Gc($) + Gc(s)) * Math.min(Math.abs($), Math.abs(s), .5 * Math.abs(x)) || 0
    }
    ...
    Cb.prototype = {
        ...
        lineEnd: function() {
            switch (this._point) {
                case 2:
                    ...
                    break;
                case 3:
                    yb(this, this._t0, yc(this, this._t0));
            }(this._line || 0 !== this._line && 1 === this._point) && this._context.closePath(), this._line = 1 - this._line
        },
        point: function(t, o) {
            var n = NaN;
            if (o = +o, (t = +t) !== this._x1 || o !== this._y1) {
                switch (this._point) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        this._point = 3, yb(this, yc(this, n = Cc(this, t, o)), n);
                        break;
                    default:
                        yb(this, this._t0, n = Cc(this, t, o));
                }
                this._x0 = this._x1, this._x1 = t, this._y0 = this._y1, this._y1 = o, this._t0 = n
            }
        }
    }, (Zf.prototype = Object.create(Cb.prototype)).point = function(t, o) {
        Cb.prototype.point.call(this, o, t)
    }, Dd.prototype = {
        moveTo: function(t, o) {
        ...
        bezierCurveTo: function(t, o, n, i, e, $) {
            this._context.bezierCurveTo(o, t, i, n, $, e)
        }
    };
    ...
    function ud(t) {
        var n, i, r = t.length - 1,
            ...
            o = new Array(r),
            a = new Array(r);
        for (e[0] = 0, o[0] = 2, a[0] = t[0] + 2 * t[1], n = 1; n < r - 1; ++n) e[n] = 1, o[n] = 4, a[n] = 4 * t[n] + 2 * t[n + 1];
        for (e[r - 1] = 2, o[r - 1] = 7, a[r - 1] = 8 * t[r - 1] + t[r], n = 1; n < r; ++n) i = e[n] / o[n - 1], o[n] -= i, a[n] -= i * a[n - 1];
        for (e[r - 1] = a[r - 1] / o[r - 1], n = r - 2; n >= 0; --n) e[n] = (a[n] - e[n + 1]) / o[n];
        for (o[r - 1] = (t[r] + e[r - 1]) / 2, n = 0; n < r - 1; ++n) o[n] = 2 * t[n + 1] - e[n + 1];
        return [e, o]
    }
    Vf.prototype = {
        areaStart: function() {
        ...
        lineEnd: function() {
            var t = this._x,
                ...
                i = t.length;
            if (i)
                if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === i) this._context.lineTo(t[1], n[1]);
                else
                    for (var r = ud(t), e = ud(n), o = 0, a = 1; a < i; ++o, ++a) this._context.bezierCurveTo(r[0][o], e[0][o], r[1][o], e[1][o], t[a], n[a]);
    ...
    var ia = {},
        Qf = ["coral", "skyblue", "#66c2a5", "tan", "#8da0cb", "#e78ac3", "#a6d854", "#ffd92f", "coral", "skyblue", "tan", "orange"];
    ia = {
        colors: Qf
    };
    var J = {};
    var Of = function(t, e, r, i, n) {
        t.svg.append("svg").attr("x", "left" === t.legendPosition ? 5 : t.width - (r + 2)).attr("y", 0);
        var a = void 0 === n ? 5 - t.margin.left : n,
            l = t.rc.rectangle("left" === t.legendPosition ? a : t.width + t.margin.right - 2 - r, -t.margin.top / 3, r, i, {
                fill: "white",
                fillWeight: .1,
                strokeWidth: .75,
                roughness: 2
            }),
            o = t.roughSvg.appendChild(l),
            g = "rough" + t.el.substring(1, t.el.length);
        o.setAttribute("class", g), e.forEach(function(e, i) {
            var n = b("." + g).append("g").attr("transform", "translate(\n        ".concat("left" === t.legendPosition ? 5 : t.width - (r + 2), ",\n        ", 0, ")"));
            n.append("rect").style("fill", t.colors[i]).attr("width", 20).attr("height", 8).attr("x", "left" === t.legendPosition ? a : t.margin.right + 5).attr("y", 6 + 11 * i - t.margin.top / 3), n.append("text").style("font-size", ".8rem").style("font-family", t.fontFamily).attr("x", "left" === t.legendPosition ? a + 25 : t.margin.right + 30).attr("y", 6 + 11 * i + 8 - t.margin.top / 3).text(e.text)
        })
    };
    J = {
        addLegend: Of
    ...
    var Bf = function(t) {
        ...
        xf = function() {
            function t(i) {
                ci(this, t), this.el = i.element, this.element = i.element, this.margin = i.margin || {
                    top: 50,
                    right: 20,
                    bottom: 10,
                    left: 20
                }, this.title = i.title, this.colors = i.colors || ia.colors, this.highlight = i.highlight, this.roughness = Bf(i.roughness) || 1, this.strokeWidth = i.strokeWidth || .75, this.innerStrokeWidth = i.innerStrokeWidth || .75, this.fillStyle = i.fillStyle, this.bowing = i.bowing || 0, this.fillWeight = i.fillWeight || .85, this.simplification = i.simplification || .2, this.interactive = !1 !== i.interactive, this.titleFontSize = i.titleFontSize, this.tooltipFontSize = i.tooltipFontSize || ".95rem", this.font = i.font || 0, this.dataFormat = "object" === bi(i.data) ? "object" : "file", this.labels = "object" === this.dataFormat ? "labels" : i.labels, this.values = "object" === this.dataFormat ? "values" : i.values, void 0 !== this.labels && void 0 !== this.values ? (this.legend = !1 !== i.legend, this.legendPosition = i.legendPosition || "right", this.initChartValues(i), this.resolveFont(), this.drawChart = this.resolveData(i.data), this.drawChart(), "undefined" !== i.title && this.setTitle(i.title)) : console.log("Error for ".concat(this.el, ": Must include labels and values when        instantiating Donut chart. Skipping chart."))
            }
            return ei(t, [{
                key: "initChartValues",
                value: function(t) {
                    var i = t.width ? t.width : 300,
                        e = t.height ? t.height : 300;
                    this.width = i - this.margin.left - this.margin.right, this.height = e - this.margin.top - this.margin.bottom, this.roughId = this.el + "_svg", this.graphClass = this.el.substring(1, this.el.length), this.interactionG = "g." + this.graphClass, this.radius = Math.min(this.width, this.height) / 2, this.setSvg()
                }
            }, {
                key: "setSvg",
                value: function() {
                ...
                value: function(t) {
                    ...
                    } : t.includes(".json") ? function() {
                        Qc(t).then(function(t) {
                            i.data = t, i.drawFromFile()
                        })
                    } : void 0
                }
                ...
                key: "setTitle",
                value: function(t) {
                    this.svg.append("text").attr("x", this.width / 2).attr("y", 0 - this.margin.top / 3).attr("class", "title").attr("text-anchor", "middle").style("font-size", void 0 === this.titleFontSize ? "".concat(Math.min(40, Math.min(this.width, this.height) / 4), "px") : this.titleFontSize).style("font-family", this.fontFamily).style("opacity", .8).text(t)
                }
            }, {
                key: "addInteraction",
                value: function() {
                    c(this.interactionG).append("g").attr("transform", "translate(".concat(this.width / 2, ", ").concat(this.height / 2, ")")).data("object" === this.dataFormat ? this.makePie(this.data[this.values]) : this.makePie(this.data)).append("path").attr("d", this.makeArc).attr("stroke-width", "0px").attr("fill", "transparent");
                    var t, i = b(this.el).append("div").style("opacity", 0).attr("class", "tooltip").style("position", "absolute").style("background-color", "white").style("border", "solid").style("border-width", "1px").style("border-radius", "5px").style("padding", "3px").style("font-family", this.fontFamily).style("font-size", this.tooltipFontSize).style("pointer-events", "none"),
                        e = this;
                    c(this.interactionG).on("mouseover", function() {
                        i.style("opacity", 1), t = b(this).selectAll("path").style("stroke"), void 0 === e.highlight ? b(this).selectAll("path").style("opacity", .5) : b(this).selectAll("path").style("stroke", e.highlight)
                    }), c(this.interactionG).on("mouseout", function() {
                        i.style("opacity", 0), b(this).selectAll("path").style("stroke", t), b(this).selectAll("path").style("opacity", 1)
                    }), c(this.interactionG).on("mousemove", function(t) {
                        var s = b(this).attr("attrX"),
                            r = b(this).attr("attrY"),
                            a = I(this);
                        i.html("<b>".concat(s, "</b> ")).style("opacity", .95).attr("class", function(t) {}).style("transform", "translate(".concat(a[0] + e.margin.left, "px, \n                            ").concat(a[1] - e.height - e.margin.bottom, "px)"))
                    })
                }
            }, {
                key: "initRoughObjects",
                ...
                value: function() {
                    var t = this;
                    this.initRoughObjects(), this.makePie = pa(), this.makeArc = ua().innerRadius(0).outerRadius(this.radius), this.arcs = this.makePie(this.data[this.values]), this.arcs.forEach(function(i, e) {
                        var s = t.rc.arc(t.width / 2, t.height / 2, 2 * t.radius, 2 * t.radius, i.startAngle - Math.PI / 2, i.endAngle - Math.PI / 2, !0, {
                            fill: t.colors[e],
                            stroke: t.colors[e]
                        });
                        s.setAttribute("class", t.graphClass);
                        var r = t.roughSvg.appendChild(s);
                        r.setAttribute("attrY", t.data[t.values][e]), r.setAttribute("attrX", t.data[t.labels][e])
                    });
                    var i = this.rc.circle(this.width / 2, this.height / 2, this.radius, {
                        fill: "white",
                        strokeWidth: .05,
                        fillWeight: 10,
                        fillStyle: "solid"
                    });
                    this.roughSvg.appendChild(i), c(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth);
                    var e = this.data.labels.map(function(i, e) {
                            return {
                                color: t.colors[e],
                                text: i
                            }
                        }),
                        s = 6 * e.reduce(function(t, i) {
                            return t > i.text.length ? t : i.text.length
                        }, 0) + 35,
                        r = 11 * e.length + 8;
                    !0 === this.legend && J.addLegend(this, e, s, r), !0 === this.interactive && this.addInteraction()
                }
            }, {
                key: "drawFromFile",
                value: function() {
                    var t = this;
                    this.initRoughObjects(), this.makePie = pa().value(function(i) {
                        return i[t.values]
                    }).sort(null);
                    var i = [];
                    this.makeArc = ua().innerRadius(0).outerRadius(this.radius), this.arcs = this.makePie(this.data), this.arcs.forEach(function(e, s) {
                        var r = t.rc.arc(t.width / 2, t.height / 2, 2 * t.radius, 2 * t.radius, e.startAngle - Math.PI / 2, e.endAngle - Math.PI / 2, !0, {
                            fill: t.colors[s],
                            stroke: t.colors[s]
                        });
                        r.setAttribute("class", t.graphClass);
                        var a = t.roughSvg.appendChild(r);
                        a.setAttribute("attrY", e.data[t.values]), a.setAttribute("attrX", e.data[t.labels]), i.push(e.data[t.labels])
                    });
                    var e = this.rc.circle(this.width / 2, this.height / 2, this.radius, {
                        fill: "white",
                        strokeWidth: .05,
                        fillWeight: 10,
                        fillStyle: "solid"
                    });
                    this.roughSvg.appendChild(e), c(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth);
                    var s = i.map(function(i, e) {
                            return {
                                color: t.colors[e],
                                text: i
                            }
                        }),
                        r = 6 * s.reduce(function(t, i) {
                            return t > i.text.length ? t : i.text.length
                        }, 0) + 35,
                        a = 11 * s.length + 8;
                    !0 === this.legend && J.addLegend(this, s, r, a), !0 === this.interactive && this.addInteraction()
                }
            }]), t
        }();
    ...
    function re(t, e, i) {
        return e && Yb(t.prototype, e), i && Yb(t, i), t
    }
    var zd = function(t) {
            return t > 20 ? 20 : t
        },
        ...
        oe = function() {
            function t(e) {
                var i = this;
                ue(this, t), this.el = e.element, this.element = e.element, this.margin = e.margin || {
                    top: 50,
                    right: 20,
                    bottom: 50,
                    left: 100
                }, this.title = e.title, this.roughness = zd(e.roughness) || 2.2, this.fillStyle = e.fillStyle, this.bowing = e.bowing || 0, this.axisStrokeWidth = e.axisStrokeWidth || .4, this.axisRoughness = e.axisRoughness || .9, this.interactive = !1 !== e.interactive, this.stroke = e.stroke || "black", this.fillWeight = e.fillWeight || .85, this.simplification = e.simplification || .2, this.colors = e.colors, this.strokeWidth = e.strokeWidth || 8, this.titleFontSize = e.titleFontSize, this.axisFontSize = e.axisFontSize, this.tooltipFontSize = e.tooltipFontSize || "0.95rem", this.font = e.font || 0, this.dataFormat = "object" === ve(e.data) ? "object" : "file", this.x = e.x, this.y = "object" === this.dataFormat ? "y" : e.y, this.xValueFormat = e.xValueFormat, this.yValueFormat = e.yValueFormat, this.legend = !1 !== e.legend, this.legendPosition = e.legendPosition || "right", this.circle = !1 !== e.circle, this.circleRadius = e.circleRadius || 10, this.circleRoughness = zd(e.circleRoughness) || 2, this.xLabel = e.xLabel || "", this.yLabel = e.yLabel || "", this.labelFontSize = e.labelFontSize || "1rem", "file" === this.dataFormat && (this.dataSources = [], this.yKeys = Object.keys(e).filter(function(t) {
                    return /y/.test(t)
                }), this.yKeys.map(function(t, o) {
                    "yLabel" !== t && i.dataSources.push(e[t])
                })), this.initChartValues(e), this.resolveFont(), this.drawChart = this.resolveData(e.data), this.drawChart(), "undefined" !== e.title && this.setTitle(e.title)
            }
            return re(t, [{
                key: "resolveFont",
                value: function() {
                ...
                key: "initChartValues",
                value: function(t) {
                    var e = t.width ? t.width : 300,
                        i = t.height ? t.height : 400;
                    this.width = e - this.margin.left - this.margin.right, this.height = i - this.margin.top - this.margin.bottom, this.roughId = this.el + "_svg", this.graphClass = this.el.substring(1, this.el.length), this.interactionG = "g." + this.graphClass, this.setSvg()
                }
            }, {
                key: "setSvg",
                value: function() {
                ...
                value: function(t) {
                    var e = this;
                    return "string" != typeof t ? function() {
                        e.data = t, e.drawFromObject()
                    } : t.includes(".csv") ? function() {
                        G(t).then(function(t) {
                            e.data = t, e.drawFromFile()
                        })
                    } : t.includes(".tsv") ? function() {
                        H(t).then(function(t) {
                            e.data = t, e.drawFromFile()
                ...
                value: function() {
                    var t, e, i = this;
                    if ("file" !== this.dataFormat) t = pe(this.data);
                    else {
                        var o = this.dataSources.map(function(t) {
                            return u(i.data, function(e) {
                                return +e[t]
                            })
                        });
                        t = [Pb(o, function(t) {
                    ...
                    if (void 0 === this.x) {
                        var a = Object.keys(this.data).map(function(t) {
                                return i.data[t].length
                            }),
                            r = x(a);
                        e = "file" === this.dataFormat ? [0, this.data.length] : [0, r]
                    } else e = u(this.x);
                    var s = t,
                        n = s[1] - s[0];
                    this.xScale = void 0 === this.x ? hc().range([0, this.width]).domain(kf(Array(e[1]).keys())) : hc().range([0, this.width]).domain(this.x), this.yScale = w().range([this.height, 0]).domain([0, s[1] + .05 * n])
                }
            }, {
                key: "addLabels",
                value: function() {
                ...
                value: function() {
                    var t = this,
                        e = fa(this.xScale).tickSize(0).tickFormat(function(e) {
                            return t.xValueFormat ? s(t.xValueFormat)(e) : e
                        }),
                        i = ea(this.yScale).tickSize(0).tickFormat(function(e) {
                            return t.yValueFormat ? s(t.yValueFormat)(e) : e
                        });
                    this.svg.append("g").attr("transform", "translate(0," + this.height + ")").call(e).attr("class", "xAxis".concat(this.graphClass)).selectAll("text").attr("transform", "translate(-10, 0)rotate(-45)").style("text-anchor", "end").style("font-family", this.fontFamily).style("font-size", void 0 === this.axisFontSize ? "".concat(Math.min(.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize), this.svg.append("g").call(i).attr("class", "yAxis".concat(this.graphClass)).selectAll("text").style("font-family", this.fontFamily).style("font-size", void 0 === this.axisFontSize ? "".concat(Math.min(.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize), c("path.domain").attr("stroke", "transparent"), c("g.tick").style("opacity", 1)
                }
            }, {
                key: "makeAxesRough",
                value: function(t, e) {
                    var i = "xAxis".concat(this.graphClass),
                        o = "yAxis".concat(this.graphClass),
                        a = "rough-".concat(i),
                        r = "rough-".concat(o);
                    b(".".concat(i)).selectAll("path.domain").each(function(i, o) {
                        var r = b(this).node().getAttribute("d"),
                            s = e.path(r, {
                                stroke: "black",
                                fillStyle: "hachure"
                            });
                        s.setAttribute("class", a), t.appendChild(s)
                    }), c(".".concat(a)).attr("transform", "translate(0, ".concat(this.height, ")")), b(".".concat(o)).selectAll("path.domain").each(function(i, o) {
                        var a = b(this).node().getAttribute("d"),
                            s = e.path(a, {
                                stroke: "black",
                                fillStyle: "hachure"
                            });
                        s.setAttribute("class", r), t.appendChild(s)
                    })
                }
            }, {
                key: "setTitle",
                value: function(t) {
                    this.svg.append("text").attr("x", this.width / 2).attr("y", 0 - this.margin.top / 2).attr("text-anchor", "middle").style("font-size", void 0 === this.titleFontSize ? "".concat(Math.min(20, Math.min(this.width, this.height) / 4), "px") : this.titleFontSize).style("font-family", this.fontFamily).style("opacity", .8).text(t)
                }
            }, {
                key: "addInteraction",
                value: function() {
                    var t = this,
                        e = this;
                    this.chartScreen = this.svg.append("g").attr("pointer-events", "all"), this.dataSources.map(function(e, i) {
                        var o = t.data.map(function(i, o) {
                                return void 0 === t.x ? [t.xScale(o), t.yScale(i[e])] : [t.xScale(t.x[o]), t.yScale(+i[e])]
                            }).filter(function(t) {
                                return void 0 !== t[0]
                            }),
                            a = Li().x(function(t) {
                        ...
                        t.svg.append("path").datum(o).attr("fill", "none").attr("stroke", "blue").attr("stroke-width", 1.5).attr("d", a).attr("visibility", "hidden");
                        var r = e + "class";
                        t.svg.append("g").attr("class", r + "text").append("text").style("font-size", t.tooltipFontSize).style("opacity", 0).style("font-family", t.fontFamily).attr("text-anchor", "middle").attr("alignment-baseline", "middle")
                    });
                    this.chartScreen.append("rect").attr("width", this.width).attr("height", this.height).attr("fill", "none").on("mousemove", function(t) {
                        var i = I(this)[0],
                            o = e.xScale.domain(),
                            a = e.xScale.range(),
                            r = sc(a[0], a[1] + 1, e.xScale.step()),
                            s = cc(r, i),
                            n = o[s];
                        e.dataSources.map(function(t, i) {
                            var o = "file" === e.dataFormat ? void 0 === e.x ? e.data[n] : e.data[s] : e.data[t][s],
                                a = "." + t + "classtext";
                            "file" === e.dataFormat ? b(a).selectAll("text").style("opacity", 1).html(void 0 === e.x ? "(".concat(s, ",").concat(o[t], ")") : "(".concat(e.x[s], ", ").concat(o[t], ")")).attr("x", void 0 === e.x ? e.xScale(s) : e.xScale(e.x[s])).attr("y", e.yScale(o[t]) - 6) : b(a).selectAll("text").style("opacity", 1).html(void 0 === e.x ? "(".concat(s, ", ").concat(o, ")") : "(".concat(e.x[s], ", ").concat(o, ")")).attr("x", void 0 === e.x ? e.xScale(s) : e.xScale(e.x[s])).attr("y", e.yScale(o))
                        })
                    }).on("mouseout", function() {
                        e.dataSources.map(function(t) {
                            b("." + t + "class" + "text").selectAll("text").style("opacity", 0)
                        })
                    })
                }
            }, {
                ...
                value: function() {
                    var t = this;
                    void 0 === this.colors && (this.colors = ia.colors), this.dataSources = Object.keys(this.data), this.initRoughObjects(), this.addScales(), this.dataSources.map(function(e, i) {
                        var o = t.data[e].map(function(e, i) {
                                return void 0 === t.x ? [t.xScale(i), t.yScale(+e)] : [t.xScale(t.x[i]), t.yScale(e)]
                            }),
                            a = o.filter(function(t) {
                                return void 0 !== t[0]
                            }),
                            r = t.rc.curve(a, {
                                stroke: 1 === t.colors.length ? t.colors[0] : t.colors[i],
                                roughness: t.roughness,
                                bowing: t.bowing
                            });
                        t.roughSvg.appendChild(r).setAttribute("class", t.graphClass), !0 === t.circle && o.forEach(function(e, o) {
                            var a = t.rc.circle(e[0], e[1], t.circleRadius, {
                                stroke: t.colors[i],
                                fill: t.colors[i],
                                fillStyle: "solid",
                                strokeWidth: 1,
                            ...
                            t.roughSvg.appendChild(a)
                        })
                    });
                    var e = this.dataSources.map(function(e, i) {
                            return {
                                color: t.colors[i],
                                text: e
                            }
                        }),
                        i = 6 * e.reduce(function(t, e) {
                            return t > e.text.length ? t : e.text.length
                        }, 0) + 35,
                        o = 11 * e.length + 8;
                    !0 === this.legend && J.addLegend(this, e, i, o, 2), this.addAxes(), this.addLabels(), this.makeAxesRough(this.roughSvg, this.rcAxis), !0 === this.interactive && this.addInteraction()
                }
            }, {
                key: "drawFromFile",
                value: function() {
                    var t = this;
                    void 0 === this.colors && (this.colors = ia.colors), this.initRoughObjects(), this.addScales(), this.dataSources.map(function(e, i) {
                        var o = t.data.map(function(i, o) {
                                return void 0 === t.x ? [t.xScale(o), t.yScale(i[e])] : [t.xScale(t.x[o]), t.yScale(+i[e])]
                            }).filter(function(t) {
                                return void 0 !== t[0]
                        ...
                        t.roughSvg.appendChild(a), !0 === t.circle && o.forEach(function(e, o) {
                            var a = t.rc.circle(e[0], e[1], t.circleRadius, {
                                stroke: t.colors[i],
                                fill: t.colors[i],
                                fillStyle: "solid",
    ...
    function fe(t, i, e) {
        return i && td(t.prototype, i), e && td(t, e), t
    }
    var de = function(t) {
            return t > 30 ? 30 : t
        },
        ce = function() {
            function t(i) {
                me(this, t), this.el = i.element, this.element = i.element, this.margin = i.margin || {
                    top: 50,
                    right: 20,
                    bottom: 10,
                    left: 20
                }, this.title = i.title, this.colors = i.colors || ia.colors, this.highlight = i.highlight, this.roughness = de(i.roughness) || 0, this.strokeWidth = i.strokeWidth || .75, this.innerStrokeWidth = i.innerStrokeWidth || 1, this.fillStyle = i.fillStyle, this.bowing = i.bowing || 0, this.fillWeight = i.fillWeight || .5, this.simplification = i.simplification || .2, this.interactive = !1 !== i.interactive, this.titleFontSize = i.titleFontSize, this.tooltipFontSize = i.tooltipFontSize || "0.95rem", this.font = i.font || 0, this.dataFormat = "object" === ne(i.data) ? "object" : "file", this.labels = "object" === this.dataFormat ? "labels" : i.labels, this.values = "object" === this.dataFormat ? "values" : i.values, void 0 !== this.labels && void 0 !== this.values ? (this.legend = !1 !== i.legend, this.legendPosition = i.legendPosition || "right", this.initChartValues(i), this.resolveFont(), this.drawChart = this.resolveData(i.data), this.drawChart(), "undefined" !== i.title && this.setTitle(i.title)) : console.log("Error for ".concat(this.el, ": Must include labels and values when        instantiating Donut chart. Skipping chart."))
            }
            return fe(t, [{
                key: "initChartValues",
                value: function(t) {
                ...
                value: function() {
                    ...
                    c(this.interactionG).on("mouseover", function() {
                        ...
                        var s = b(this).attr("attrX"),
                            r = b(this).attr("attrY"),
                            o = I(this);
                        i.html("<b>".concat(s, "</b> ")).style("opacity", .95).attr("class", function(t) {}).style("transform", "translate(".concat(o[0] + e.margin.left, "px, \n                            ").concat(o[1] - e.height - e.margin.bottom, "px)"))
                    })
                }
            }, {
                key: "initRoughObjects",
                ...
                value: function() {
                    ...
                    this.initRoughObjects(), this.makePie = pa(), this.makeArc = ua().innerRadius(0).outerRadius(this.radius), this.arcs = this.makePie(this.data[this.values]), this.arcs.forEach(function(i, e) {
                        ...
                        var r = t.roughSvg.appendChild(s);
                        r.setAttribute("attrY", t.data[t.values][e]), r.setAttribute("attrX", t.data[t.labels][e])
                    }), c(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth);
                    var i = this.data.labels.map(function(i, e) {
                            return {
                                color: t.colors[e],
                                text: i
                            }
                        }),
                        e = 6 * i.reduce(function(t, i) {
                            return t > i.text.length ? t : i.text.length
                        }, 0) + 35,
                        s = 11 * i.length + 8;
                    !0 === this.legend && J.addLegend(this, i, e, s), !0 === this.interactive && this.addInteraction()
                }
            }, {
                key: "drawFromFile",
                value: function() {
                    ...
                    this.makeArc = ua().innerRadius(0).outerRadius(this.radius), this.arcs = this.makePie(this.data), this.arcs.forEach(function(e, s) {
                        ...
                        r.setAttribute("class", t.graphClass);
                        var o = t.roughSvg.appendChild(r);
                        o.setAttribute("attrY", e.data[t.values]), o.setAttribute("attrX", e.data[t.labels]), i.push(e.data[t.labels])
                    }), c(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth);
                    var e = i.map(function(i, e) {
                            return {
                                color: t.colors[e],
                                text: i
                            }
    ...
    function Yd(t, i, e) {
        return i && jd(t.prototype, i), e && jd(t, e), t
    }
    var Wd = function(t) {
            return t > 20 ? 20 : t
        },
        ic = ["pink", "skyblue", "coral", "gold", "teal", "grey", "darkgreen", "pink", "brown", "slateblue", "grey1", "orange"],
        Td = function() {
            function t(i) {
                ae(this, t), this.el = i.element, this.element = i.element, this.margin = i.margin || {
                    top: 50,
                    right: 20,
                    bottom: 50,
                    left: 100
                }, this.title = i.title, this.colorVar = i.colorVar, this.roughness = Wd(i.roughness) || 1, this.highlight = i.highlight, this.highlightLabel = i.highlightLabel || "xy", this.radius = i.radius || 8, this.fillStyle = i.fillStyle, this.bowing = i.bowing || 0, this.axisStrokeWidth = i.axisStrokeWidth || .4, this.axisRoughness = i.axisRoughness || .9, this.interactive = !1 !== i.interactive, this.curbZero = !0 === i.curbZero, this.innerStrokeWidth = i.innerStrokeWidth || 1, this.stroke = i.stroke || "black", this.fillWeight = i.fillWeight || .85, this.simplification = i.simplification || .2, this.colors = i.colors, this.strokeWidth = i.strokeWidth || 1, this.titleFontSize = i.titleFontSize, this.axisFontSize = i.axisFontSize, this.tooltipFontSize = i.tooltipFontSize || "0.95rem", this.font = i.font || 0, this.dataFormat = "object" === be(i.data) ? "object" : "file", this.x = "object" === this.dataFormat ? "x" : i.x, this.y = "object" === this.dataFormat ? "y" : i.y, this.xValueFormat = i.xValueFormat, this.yValueFormat = i.yValueFormat, this.xLabel = i.xLabel || "", this.yLabel = i.yLabel || "", this.labelFontSize = i.labelFontSize || "1rem", this.initChartValues(i), this.resolveFont(), this.drawChart = this.resolveData(i.data), this.drawChart(), "undefined" !== i.title && this.setTitle(i.title)
            }
            return Yd(t, [{
                key: "resolveFont",
                value: function() {
                ...
                value: function() {
                    var t = this,
                        i = "file" === this.dataFormat ? u(this.data, function(i) {
                            return +i[t.x]
                        }) : u(this.data[this.x]),
                        e = i[1] - i[0],
                        s = "file" === this.dataFormat ? u(this.data, function(i) {
                            return +i[t.y]
                        }) : u(this.data[this.y]),
                        a = s[1] - s[0],
                        r = "file" === this.dataFormat ? u(this.data, function(i) {
                            return i[t.colorVar]
                        }) : [1, 1];
                    if ("file" === this.dataFormat) {
                        var o = u(this.data, function(i) {
                                return +i[t.radius]
                            }),
                            l = Math.min(this.width, this.height) / 2 / 2;
                        this.radiusScale = w().range([8, l]).domain(o)
                    }!0 === this.curbZero && (s[0] > 0 && (s[0] = 0), i[0] > 0 && (i[0] = 0)), this.xScale = w().range([0, this.width]).domain([i[0] - .05 * e, i[1] + .05 * e]), this.yScale = w().range([this.height, 0]).domain([s[0] - .05 * a, s[1] + .05 * a]), this.colorScale = za().range(this.colors).domain(r)
                }
            }, {
                key: "addLabels",
                value: function() {
                ...
                value: function() {
                    ...
                    this.svg.append("g").attr("transform", "translate(0," + this.height + ")").call(i).attr("class", "xAxis".concat(this.graphClass)).selectAll("text").attr("transform", "translate(-10, 0)rotate(-45)").style("text-anchor", "end").style("font-family", this.fontFamily).style("font-size", void 0 === this.axisFontSize ? "".concat(Math.min(.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize), this.svg.append("g").call(e).attr("class", "yAxis".concat(this.graphClass)).selectAll("text").style("font-family", this.fontFamily).style("font-size", void 0 === this.axisFontSize ? "".concat(Math.min(.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize), c("path.domain").attr("stroke", "transparent"), c("g.tick").style("opacity", 1)
                }
            }, {
                key: "makeAxesRough",
                value: function(t, i) {
                    var e = "xAxis".concat(this.graphClass),
                        s = "yAxis".concat(this.graphClass),
                        a = "rough-".concat(e),
                        r = "rough-".concat(s);
                    b(".".concat(e)).selectAll("path.domain").each(function(e, s) {
                        var r = b(this).node().getAttribute("d"),
                            o = i.path(r, {
                                stroke: "black",
                                fillStyle: "hachure"
                    ...
                    }), c(".".concat(a)).attr("transform", "translate(0, ".concat(this.height, ")")), b(".".concat(s)).selectAll("path.domain").each(function(e, s) {
                        var a = b(this).node().getAttribute("d"),
                            o = i.path(a, {
                                stroke: "black",
                                fillStyle: "hachure"
                            });
                        o.setAttribute("class", r), t.appendChild(o)
                    })
                }
            }, {
                key: "setTitle",
                ...
                value: function() {
                    var t = this,
                        i = c(this.interactionG).data("file" === this.dataFormat ? this.data : this.data.x).append("circle").attr("cx", function(i, e) {
                            return "file" === t.dataFormat ? t.xScale(+i[t.x]) : t.xScale(+t.data[t.x][e])
                        }).attr("cy", function(i, e) {
                            return "file" === t.dataFormat ? t.yScale(+i[t.y]) : t.yScale(+t.data[t.y][e])
                        });
                    "file" === this.dataFormat ? i.attr("r", function(i) {
                        return "number" == typeof t.radius ? .7 * t.radius : .6 * t.radiusScale(+i[t.radius])
                    }).attr("fill", "transparent") : i.attr("r", function(i, e) {
                        return "number" == typeof t.radius ? .7 * t.radius : .6 * t.radius[e]
                    }).attr("fill", "transparent");
                    var e, s = b(this.el).append("div").style("opacity", 0).attr("class", "tooltip").style("position", "absolute").style("background-color", "white").style("border", "solid").style("border-width", "1px").style("border-radius", "5px").style("padding", "3px").style("font-family", this.fontFamily).style("font-size", this.tooltipFontSize).style("pointer-events", "none"),
                        a = this;
                    c(this.interactionG).on("mouseover", function() {
                        s.style("opacity", 1), e = b(this).selectAll("path").style("stroke"), void 0 === a.highlight ? b(this).selectAll("path:nth-child(1)").style("opacity", .4) : b(this).selectAll("path:nth-child(1)").style("stroke", a.highlight), b(this).selectAll("path:nth-child(2)").style("stroke-width", a.strokeWidth + 1.2)
                    }), c(this.interactionG).on("mouseout", function() {
                        s.style("opacity", 0), b(this).selectAll("path").style("opacity", 1), b(this).selectAll("path:nth-child(1)").style("stroke", e), b(this).selectAll("path:nth-child(2)").style("stroke", a.stroke), b(this).selectAll("path:nth-child(2)").style("stroke-width", a.strokeWidth)
                    }), c(this.interactionG).on("mousemove", function(t) {
                        var i = b(this).attr("attrX"),
                            e = b(this).attr("attrY"),
                            r = b(this).attr("attrHighlightLabel"),
                            o = I(this);
                        s.html("xy" === a.highlightLabel ? "<b>x</b>: ".concat(i, " <br><b>y</b>: ").concat(e) : "<b>".concat(r, "</b>")).attr("class", function(t) {}).style("transform", "translate(".concat(o[0] + a.margin.left, "px, \n          ").concat(o[1] - (a.height + a.margin.top + a.margin.bottom), "px)"))
                    })
                }
            }, {
                key: "initRoughObjects",
                ...
                value: function() {
                    var t = this;
                    void 0 === this.colors && (this.colors = ic[0]), this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.x.forEach(function(i, e) {
                        var s = t.rc.circle(t.xScale(+i), t.yScale(+t.data[t.y][e]), "number" == typeof t.radius ? t.radius : t.radius[e], {
                                fill: "string" == typeof t.colors ? t.colors : 1 === t.colors.length ? t.colors[0] : t.colors[e],
                                simplification: t.simplification,
                                fillWeight: t.fillWeight
                            }),
                            a = t.roughSvg.appendChild(s);
                        a.setAttribute("class", t.graphClass), a.setAttribute("attrX", i), a.setAttribute("attrY", t.data[t.y][e]), a.setAttribute("attrHighlightLabel", t.data[t.highlightLabel])
                    }), c(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth), !0 === this.interactive && this.addInteraction()
                }
            }, {
                key: "drawFromFile",
                value: function() {
                    var t = this;
                    void 0 === this.colors && (this.colors = ic), this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.forEach(function(i, e) {
                        var s = t.rc.circle(t.xScale(+i[t.x]), t.yScale(+i[t.y]), "number" == typeof t.radius ? t.radius : t.radiusScale(+i[t.radius]), {
                                fill: void 0 === t.colorVar ? t.colors[0] : t.colorScale(i[t.colorVar]),
                                simplification: t.simplification,
                                fillWeight: t.fillWeight
                            }),
                            a = t.roughSvg.appendChild(s);
                        a.setAttribute("class", t.graphClass), a.setAttribute("attrX", i[t.x]), a.setAttribute("attrY", i[t.y]), a.setAttribute("attrHighlightLabel", i[t.highlightLabel])
                    }), c(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth), !0 === this.interactive && this.addInteraction()
                }
            }]), t
        }();
    ...
    function Pd(t, i, e) {
        return i && ac(t.prototype, i), e && ac(t, e), t
    }
    var Od = function(t) {
            return t > 20 ? 20 : t
        },
        Zi = function() {
            function t(i) {
                Rd(this, t), this.el = i.element, this.data = i.data, this.element = i.element, this.margin = i.margin || {
                    top: 50,
                    right: 20,
                    bottom: 70,
                    left: 100
                }, this.title = i.title, this.colors = i.colors || ia.colors, this.highlight = i.highlight || "coral", this.roughness = Od(i.roughness) || 1, this.stroke = i.stroke || "black", this.strokeWidth = i.strokeWidth || 1, this.axisStrokeWidth = i.axisStrokeWidth || .5, this.axisRoughness = i.axisRoughness || .5, this.innerStrokeWidth = i.innerStrokeWidth || 1, this.fillStyle = i.fillStyle, this.bowing = i.bowing || 0, this.fillWeight = i.fillWeight || .5, this.simplification = i.simplification || .2, this.interactive = !1 !== i.interactive, this.titleFontSize = i.titleFontSize, this.axisFontSize = i.axisFontSize, this.tooltipFontSize = i.tooltipFontSize || "0.95rem", this.font = i.font || 0, this.dataFormat = "object" === Sd(i.data) ? "object" : "file", this.labels = i.labels, this.values = i.values, this.padding = i.padding || .1, this.xLabel = i.xLabel || "", this.yLabel = i.yLabel || "", this.labelFontSize = i.labelFontSize || "1rem", this.initChartValues(i), this.resolveFont(), this.drawChart = this.resolveData(i.data), this.drawChart(), "undefined" !== i.title && this.setTitle(i.title)
            }
            return Pd(t, [{
                key: "initChartValues",
                value: function(t) {
                ...
                value: function(t) {
                    for (var i = 0; i < t.length; i++) {
                        for (var e = 0, s = 0; s < t.columns.length; ++s) t.columns[s] !== this.labels && (e += t[i][t.columns[s]] = +t[i][t.columns[s]]);
                        t[i].total = e
                    }
                    return t
                }
                    ...
                    return "string" != typeof t ? function() {
                        ...
                        for (var e = function(e) {
                                ...
                                Object.keys(t[e]).forEach(function(a) {
                                    a !== i.labels && (s += t[e][a], t[e].total = s)
                                })
                            }, s = 0; s < t.length; ++s) e(s);
                        i.drawFromObject()
                    } : t.includes(".csv") ? function() {
                        G(t).then(function(t) {
                            i.getTotal(t), i.data = t, i.drawFromFile()
                        })
                    } : t.includes(".tsv") ? function() {
                        H(t).then(function(t) {
                            i.getTotal(t), i.data = t, i.drawFromFile()
                ...
                value: function() {
                    var t = this;
                    this.xScale = T().rangeRound([0, this.width]).padding(this.padding).domain(this.data.map(function(i) {
                        return i[t.labels]
                    })), this.data.sort(function(t, i) {
                        return i.total - t.total
                    }), this.yScale = w().rangeRound([this.height, 0]).domain([0, x(this.data, function(t) {
                        return t.total
                    })]).nice();
                    var i = "object" === this.dataFormat ? this.data.map(function(i) {
                        return i[t.labels]
                    }) : this.data.columns;
                    this.zScale = za().range(["#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00"]).domain(i)
                }
            }, {
                key: "addLabels",
                value: function() {
                ...
                key: "addAxes",
                value: function() {
                    var t = fa(this.xScale).tickSize(0);
                    this.svg.append("g").attr("transform", "translate(0," + this.height + ")").call(t).attr("class", "xAxis".concat(this.graphClass)).selectAll("text").attr("transform", "translate(-10,0)rotate(-45)").style("text-anchor", "end").style("font-family", this.fontFamily).style("font-size", void 0 === this.axisFontSize ? "".concat(Math.min(.8, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize).style("opacity", .9);
                    var i = ea(this.yScale).tickSize(0);
                    this.svg.append("g").call(i).attr("class", "yAxis".concat(this.graphClass)).selectAll("text").style("font-family", this.fontFamily).style("font-size", void 0 === this.axisFontSize ? "".concat(Math.min(.95, Math.min(this.width, this.height) / 140), "rem") : this.axisFontSize).style("opacity", .9), c("path.domain").attr("stroke", "transparent")
                }
            }, {
                key: "makeAxesRough",
                value: function(t, i) {
                ...
                key: "addInteraction",
                value: function() {
                    c(this.interactionG).each(function(t, i) {
                        var e = this.attributes;
                        b(this).append("rect").attr("x", e.x.value).attr("y", e.y.value).attr("width", e.width.value).attr("height", e.height.value).attr("fill", "transparent")
                    });
                    var t, i = b(this.el).append("div").style("opacity", 0).attr("class", "tooltip").style("position", "absolute").style("background-color", "white").style("border", "solid").style("border-width", "1px").style("border-radius", "5px").style("padding", "3px").style("font-family", this.fontFamily).style("font-size", this.tooltipFontSize).style("pointer-events", "none"),
                        e = this;
                    c(this.interactionG).on("mouseover", function() {
                        i.style("opacity", 1), t = b(this).selectAll("path").style("stroke"), b(this).select("path").style("stroke", e.highlight), b(this).selectAll("path:nth-child(2)").style("stroke-width", e.strokeWidth + 1.2)
                    }), c(this.interactionG).on("mouseout", function() {
                        i.style("opacity", 0), b(this).select("path").style("stroke", t), b(this).selectAll("path:nth-child(2)").style("stroke-width", e.strokeWidth)
                    }), c(this.interactionG).on("mousemove", function(t) {
                        var s = b(this).attr("attrX"),
                            a = b(this).attr("attrY"),
                            o = b(this).attr("keyY"),
                            r = I(this);
                        i.html("<h4>".concat(s, "</h4> <b>").concat(o, "</b>: ").concat(a)).style("opacity", .95).attr("class", function(t) {}).style("transform", "translate(".concat(r[0] + e.margin.left, "px, \n          ").concat(r[1] - (e.height + e.margin.top + e.margin.bottom), "px)"))
                    })
                }
            }, {
                key: "initRoughObjects",
                ...
                value: function() {
                    ...
                    this.data.forEach(function(i) {
                        ...
                        e.forEach(function(e, a) {
                            if (a > 0 && "total" !== e) {
                                s += parseInt(i[e]);
                                var o = t.xScale(i[t.labels]),
                                    r = t.yScale(s),
                                    l = t.xScale.bandwidth(),
                                    h = t.height - t.yScale(+i[e]),
                                    n = t.rc.rectangle(o, r, l, h, {
                                        fill: t.colors[a],
                                        stroke: t.colors[a],
                                        simplification: t.simplification,
                                        fillWeight: t.fillWeight
                                    }),
                                    c = t.roughSvg.appendChild(n);
                                c.setAttribute("class", t.graphClass), c.setAttribute("attrX", i[t.labels]), c.setAttribute("keyY", e), c.setAttribute("attrY", +i[e]), c.setAttribute("x", o), c.setAttribute("y", r), c.setAttribute("width", l), c.setAttribute("height", h)
                            }
                        })
                    })
                }
                ...
                key: "drawFromObject",
                value: function() {
                    this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.stacking(), c(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth), !0 === this.interactive && this.addInteraction()
                }
            }, {
                key: "drawFromFile",
                value: function() {
